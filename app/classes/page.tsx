          ...
          <div className={`overflow-hidden transition-all duration-500 ease-in-out border-x-2 border-b-2 border-amber-900/30 rounded-b-xl bg-[#fbf5e6] ${isIntroOpen ? 'max-h-[500000px] opacity-100' : 'max-h-0 opacity-0 border-transparent'}`}>
            ...
            <div className="p-8 sm:p-10 font-serif text-amber-950/85 text-justify leading-relaxed flex flex-col gap-8">
              ...
              <section className="border-t-2 border-amber-900/20 pt-8">
                <h2 className="text-2xl font-bold text-red-800 mb-4 tracking-wide">Escolhendo sua Classe</h2>
              ...
              <section className="border-t-2 border-amber-900/20 pt-8">
                <h3 className="text-xl font-bold text-red-800 mb-4 tracking-wide">Características das Classes</h3>
              ...
              <section className="border-t-2 border-amber-900/20 pt-8">
                <h3 className="text-xl font-bold text-red-800 mb-4 tracking-wide">Habilidades e Poderes de Classes</h3>
              ...
              <section className="border-t-2 border-amber-900/20 pt-8">
                <h3 className="text-xl font-bold text-red-800 mb-4 tracking-wide">Subindo de Nível</h3>
              ...
              <section className="border-t-2 border-amber-900/20 pt-8">
                <h3 className="text-xl font-bold text-red-800 mb-4 tracking-wide">Multiclasse</h3>
              ...
              <section className="border-t-2 border-amber-900/20 pt-8">
                <h3 className="text-xl font-bold text-red-800 mb-4 tracking-wide">Patamares de Jogo</h3>
                ...
                <div className="space-y-3 text-base text-left">
                  <p className="p-4 bg-[#e8dac1]/50 rounded-lg border border-amber-900/20 shadow-sm"><span className="text-amber-950 font-bold">Iniciante (1º ao 4º nível):</span> Aventureiro novato, envolvido em missões locais, como proteger vilas do ataque de bandidos e escoltar caravanas.</p>
                  <p className="p-4 bg-[#e8dac1]/50 rounded-lg border border-amber-900/20 shadow-sm"><span className="text-amber-700 font-bold">Veterano (5º ao 10º nível):</span> Neste patamar, o herói presta serviços importantes a nobres e líderes de guildas.</p>
                  <p className="p-4 bg-[#e8dac1]/50 rounded-lg border border-amber-900/20 shadow-sm"><span className="text-red-800 font-bold">Campeão (11º ao 16º nível):</span> Já famoso por suas façanhas, o aventureiro trabalha para monarcas e enfrenta grandes vilões e monstros terríveis.</p>
                  <p className="p-4 bg-[#e8dac1]/50 rounded-lg border border-purple-900/20 shadow-sm"><span className="text-purple-800 font-bold">Lenda (17º ao 20º nível):</span> Entre os mais poderosos de Arton, o herói lida com perigos que ameaçam todo o mundo... Ou mesmo toda a realidade!</p>
                </div>
              </section>

              <section className="border-t-2 border-amber-900/20 pt-8">
                <h3 className="text-xl font-bold text-red-800 mb-4 tracking-wide">Classes Variantes</h3>
                <div className="space-y-4">
              ...
              <section className="border-t-2 border-amber-900/20 pt-8">
                <h3 className="text-xl font-bold text-red-800 mb-4 tracking-wide">Classes Divinas</h3>
              ...
              <section className="border-t-2 border-amber-900/20 pt-8">
                <h3 className="text-xl font-bold text-red-800 mb-4 tracking-wide">“Posso servir a mais de uma divindade?”</h3>
                <div className="space-y-4">
              ...
              <section className="border-t-2 border-amber-900/20 pt-8">
                <h3 className="text-xl font-bold text-red-800 mb-4 tracking-wide">Nova Regra: Devoção Ampla</h3>
          ...
          {filteredClasses.map((cls) => (
            ...
            >
              ...
              <div className="relative p-5 text-center flex-1 flex flex-col justify-between bg-[#e8dac1]">
                ...
                {/* Detalhes nos cantos ajustados para acompanhar o hover e o border-2 */}
        ...
        >
          ...
          <div className="bg-[#fbf5e6] border-4 border-double border-amber-900/40 rounded-xl shadow-[0_0_60px_rgba(69,26,3,0.3)] max-w-4xl w-full max-h-[95vh] overflow-y-auto relative custom-scrollbar bg-[url('/noise.png')]">
            ...
            <button
              ...
              className="absolute top-4 right-4 md:top-6 md:right-6 text-amber-900/60 hover:text-red-800 transition-colors z-10 bg-[#e8dac1] border-2 border-amber-900/30 rounded-full w-10 h-10 flex items-center justify-center text-2xl pb-1 shadow-sm"
            >
              ×
            </button>
            ...
            <div className="p-5 md:p-12 font-serif text-amber-950/85">
              ...
              <div className="mb-8 md:mb-10 text-center border-b-2 border-amber-900/20 pb-6 md:pb-8 mt-4 md:mt-0">
                  ...
                  <h2 className="text-4xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-b from-amber-700 via-red-800 to-amber-950 mb-4 tracking-wider uppercase">
                    {selectedClass.name}
                  </h2>
              ...
              {selectedClass.famousExamples && selectedClass.famousExamples.length > 0 && (
                <div className="mb-10 text-center px-4">
                  <h3 className="text-sm md:text-base font-bold text-amber-900/50 mb-2 uppercase tracking-widest flex items-center justify-center gap-2">
                    Nomes Grandiosos
                  </h3>
              ...
              <div className="mb-12">
                <h3 className="text-2xl md:text-3xl font-bold text-red-800 mb-6 text-center border-b-2 border-amber-900/20 pb-2 tracking-wide">Características de Classe</h3>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
                  <div className="p-4 md:p-5 rounded-xl bg-[#e8dac1] border-2 border-amber-900/20 text-center shadow-sm">
                    <p className="text-amber-950/60 text-xs font-bold uppercase tracking-widest mb-2">PV Iniciais</p>
                  ...
                  <div className="p-4 md:p-5 rounded-xl bg-[#e8dac1] border-2 border-amber-900/20 text-center shadow-sm">
                    <p className="text-amber-950/60 text-xs font-bold uppercase tracking-widest mb-2">PV por Nível</p>
                    <p className="text-red-800 text-3xl md:text-4xl font-bold flex items-center justify-center gap-1">
                  ...
                  <div className="p-4 md:p-5 rounded-xl bg-[#e8dac1] border-2 border-amber-900/20 text-center shadow-sm">
                    <p className="text-amber-950/60 text-xs font-bold uppercase tracking-widest mb-2">PM por Nível</p>
                    <p className="text-blue-800/90 text-3xl md:text-4xl font-bold flex items-center justify-center gap-1">
              ...
              {/* Perícias */}
              <div className="mb-8">
                  <h3 className="text-xl md:text-2xl font-bold text-red-800 mb-6 border-b-2 border-amber-900/20 pb-2 flex items-center gap-2 tracking-wide">
                    Perícias
                  </h3>
                  <div className="grid grid-cols-1 gap-6">
                    <div>
                        <p className="text-amber-950/60 mb-3 text-sm uppercase tracking-widest font-bold flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <span key={index} className="px-3 py-1.5 rounded-lg bg-[#e8dac1] border border-amber-900/20 text-amber-950/80 text-sm md:text-base font-medium shadow-sm">
                                {skill}
                            </span>
                            ))}
                        </div>
              ...
              <div className="mb-12">
                  ...
                  <div className="p-5 md:p-6 bg-[#e8dac1]/50 rounded-xl border-2 border-amber-900/20 shadow-inner flex items-start gap-4">
              ...
              {selectedClass.powersUrl && (
                <div className="mb-14">
                  <Link 
                    ...
                    className="group block w-full text-center py-5 bg-[#7f1d1d] text-amber-50 rounded-xl border-2 border-[#450a0a] shadow-md hover:bg-[#991b1b] hover:-translate-y-1 transition-all duration-200"
                  >
                    <span className="text-lg md:text-xl font-bold uppercase tracking-widest group-hover:tracking-[0.2em] transition-all">
                        Ver Poderes de {selectedClass.name}
                    </span>
                    <div className="text-xs text-amber-200/60 mt-1 uppercase tracking-widest">Clique para acessar a lista completa</div>
                  </Link>
                </div>
              )}
              ...
              <div className="mb-12">
                <h3 className="text-2xl md:text-3xl font-bold text-red-800 mb-6 md:mb-8 text-center border-b-2 border-amber-900/20 pb-2 tracking-wide">Habilidades de Classe</h3>
                <div className="space-y-6 md:space-y-8">
                  {selectedClass.abilities.map((ability, index) => (
                    <div key={index} className="relative group">
                      {/* Cards de habilidades com rounded-xl e border-2 */}
                      <div className="rounded-xl bg-[#fbf5e6] border-2 border-amber-900/20 overflow-hidden shadow-sm hover:border-red-800/40 transition-colors">
                        <div className="p-4 md:p-5 bg-[#e8dac1] border-b-2 border-amber-900/20">
                          <h4 className="text-xl md:text-2xl font-bold text-red-800 tracking-wide">{ability.name}</h4>
                        </div>
                            ...
                            <div className="space-y-6 mt-6 md:mt-8">
                              {ability.subAbilities.map((subAbility, subIndex) => (
                                <div key={subIndex} className="pl-4 md:pl-6 border-l-4 border-amber-900/30">
                                  <h5 className="text-lg md:text-xl font-bold text-red-800 mb-2 flex items-center gap-2">
                ...
                <div className="mb-12 p-5 md:p-8 bg-[#e8dac1] rounded-xl border-2 border-amber-900/20 shadow-inner">
                  ...
                  <div className="space-y-8">
                    {selectedClass.extras.map((extra, index) => (
                      ...
                      >
                        <h4 className="text-amber-950 font-bold text-lg md:text-xl mb-3">{extra.title}</h4>
                        ...
                        {extra.sections && (
                          <div className="space-y-4 md:space-y-6 mt-4 pl-2 md:pl-4 border-l-2 border-amber-900/20">
                            {extra.sections.map((section, sIndex) => (
                              ...
                              <div key={sIndex} className="bg-[#fbf5e6] p-4 md:p-5 rounded-lg border border-amber-900/10 shadow-sm">
                                <h5 className="text-red-800 font-bold text-base md:text-lg mb-2 uppercase tracking-wider">
                                  {section.title}
                                </h5>
              ...
              <div className="mb-8">
                ...
                <div className="overflow-x-auto rounded-xl border-2 border-amber-900/30 shadow-sm">
                  ...
                  <table className="w-full text-left min-w-[500px]">
                    <thead>
                      <tr className="bg-[#e8dac1] border-b-2 border-amber-900/30">
                        <th className="p-3 md:p-4 text-amber-950/70 font-bold w-20 md:w-24 uppercase text-xs md:text-sm tracking-widest border-r-2 border-amber-900/30 text-center">Nível</th>
                        <th className="p-3 md:p-4 text-amber-950/70 font-bold uppercase text-xs md:text-sm tracking-widest">Habilidades Adquiridas</th>
                      </tr>
                    </thead>
                    <tbody className="bg-[#fbf5e6] divide-y divide-amber-900/10">
                      {selectedClass.levelProgression.map((progression, index) => (
                        <tr
                          key={index}
                          className={`${index % 2 === 0 ? 'bg-[#fbf5e6]' : 'bg-[#f2e8d5]'} hover:bg-[#e8dac1]/50 transition-colors`}
                        >
