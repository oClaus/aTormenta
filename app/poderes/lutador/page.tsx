    ...
    <div className="min-h-screen bg-stone-950 text-stone-200 font-serif selection:bg-red-900 selection:text-white relative overflow-x-hidden">
      ...
      <header className="relative z-10 w-full p-6 border-b-2 border-stone-800 bg-stone-950/90 backdrop-blur-md shadow-lg mb-8 md:mb-12">
        <div className="w-full px-4 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 flex-wrap text-xs sm:text-sm font-bold tracking-wide uppercase self-end md:self-auto">
                ...
                <span className="text-stone-700">/</span>
                <span className="text-red-700">Poderes de Lutador</span>
            </div>
        </div>
      </header>
      ...
      <div className="relative z-10 w-full px-4 sm:px-8 md:px-12 pb-12">
        ...
        <div className="mb-12 p-8 bg-stone-900/50 rounded border border-stone-800 w-full">
            <h1 className="text-4xl sm:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-amber-500 to-orange-500 mb-6 drop-shadow-md">
            Poderes de Lutador
            </h1>
            <p className="text-stone-300 text-lg font-serif">Poderes exclusivos da classe Lutador:</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6 items-stretch">
            ...
            <div
                key={power.id}
                className="rounded-xl bg-stone-900 border border-stone-800 p-6 hover:border-orange-900/50 hover:shadow-[0_0_20px_rgba(249,115,22,0.15)] transition-all duration-300 flex flex-col h-full group hover:-translate-y-1"
            >
                {/* Nome do Poder */}
                <h3 className="text-xl font-bold text-orange-500 mb-3 group-hover:text-orange-400 transition-colors font-serif">
                {power.name}
                </h3>
