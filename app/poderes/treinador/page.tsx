    ...
    <div className="min-h-screen bg-stone-950 text-stone-200 font-serif selection:bg-red-900 selection:text-white relative overflow-x-hidden">
      ...
      <header className="relative z-10 w-full p-6 border-b-2 border-stone-800 bg-stone-950/90 backdrop-blur-md shadow-lg mb-8 md:mb-12">
        <div className="w-full px-4 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 flex-wrap text-xs sm:text-sm font-bold tracking-wide uppercase self-end md:self-auto">
                ...
                <span className="text-stone-700">/</span>
                <span className="text-red-700">Poderes de Treinador</span>
            </div>
        </div>
      </header>
      ...
      <div className="relative z-10 w-full px-4 sm:px-8 md:px-12 pb-12">
        ...
        <div className="mb-12 p-8 bg-stone-900/50 rounded border border-stone-800 w-full">
            ...
            <p className="text-stone-300 text-lg font-serif">Poderes exclusivos da classe Treinador:</p>
        </div>
        ...
        <div className="mt-16 p-8 rounded bg-stone-900/50 border border-stone-800 w-full space-y-6">
            <div>
                <h3 className="text-2xl font-bold text-violet-500 mb-4 font-serif">Mascotes</h3>
                <p className="text-stone-300 leading-relaxed font-serif">Um mascote é uma criatura com a qual você desenvolveu uma grande afinidade. Em termos de jogo, é um parceiro especial que não conta em seu limite de parceiros e com o qual você pode se comunicar através de gestos em alcance médio. Ele obedece a seus comandos, mas ainda está limitado ao que uma criatura de sua espécie pode fazer. Mascotes fornecem seus benefícios tanto para você quanto para seus melhores amigos. Se perder um de seus mascotes, você pode treinar um novo com uma semana de trabalho e T$ 100.</p>
            </div>

            <div className="space-y-2 text-stone-400 font-serif">
                <p><span className="text-violet-400 font-bold">Águia Real </span><span className="text-stone-300 leading-relaxed">Uma vez por rodada, fornece +1d6 em uma rolagem de dano com arma.</span></p>
                <p><span className="text-violet-400 font-bold">Bicho Preguiça </span><span className="text-stone-300 leading-relaxed">Agarrado às costas (suas ou de seu melhor amigo), este animal ocupa o espaço de um item vestido, mas fornece um ataque natural de garra (dano 1d6, crítico x2, corte). Uma vez por rodada, quando usa a ação agredir para atacar com outra arma, você pode gastar 1 PM para fazer um ataque corpo a corpo extra com essa garra.</span></p>
                <p><span className="text-violet-400 font-bold">Camundongo Espiritual </span><span className="text-stone-300 leading-relaxed">Aumenta a CD para resistir a habilidades mágicas em +1.</span></p>
                <p><span className="text-violet-400 font-bold">Fada-Borboleta </span><span className="text-stone-300 leading-relaxed">Diminui o custo de habilidades mágicas em –1.</span></p>
                <p><span className="text-violet-400 font-bold">Gekko Malhado </span><span className="text-stone-300 leading-relaxed">Fornece +2 na Defesa e em Reflexos.</span></p>
                <p><span className="text-violet-400 font-bold">Mico-Leão Dourado </span><span className="text-stone-300 leading-relaxed">Permite usar Ladinagem para punga em alcance curto.</span></p>
                <p><span className="text-violet-400 font-bold">Minivaca </span><span className="text-stone-300 leading-relaxed">Fornece +1 em testes de ataque. Esse bônus dobra em investidas.</span></p>
                <p><span className="text-violet-400 font-bold">Ossinhos </span><span className="text-stone-300 leading-relaxed">O esqueleto de um animal reanimado. Fornece redução de corte, frio e perfuração 2.</span></p>
            </div>
        </div>
      </div>
