        ...
        <div className="mb-12 w-full">
          ...
          <div className={`overflow-hidden transition-all duration-500 ease-in-out border-x-2 border-b-2 border-amber-900/30 rounded-b-xl bg-[rgb(var(--bg-inset-rgb))] ${isIntroOpen ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0 border-transparent'}`}>
            <div className="p-5 md:p-10 font-serif text-amber-950/85 text-base md:text-lg text-left md:text-justify leading-relaxed flex flex-col gap-8">
              ...
              {/* Seção 1: Julgamentos Divinos */}
              <section>
                <h3 className="font-display text-2xl font-bold text-red-800 mb-4 tracking-wide border-b-2 border-amber-900/20 pb-2">Julgamentos Divinos</h3>
                ...
                <ul className="space-y-4 mb-6">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="font-medium">Proferir um julgamento gasta uma ação de movimento, a menos que a descrição diga o contrário.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[10px] text-red-800/60 mt-2">◆</span>
                    <span className="font-medium">Julgamentos que não têm um efeito instantâneo duram até o fim da cena.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[10px] text-red-800/60 mt-2">◆</span>
                    <span className="font-medium">Uma mesma criatura pode ser alvo de vários julgamentos diferentes, mas efeitos do mesmo julgamento não se acumulam.</span>
                  </li>
                </ul>
              </section>

              {/* Seção 2: Virtudes Paladinescas */}
              <section className="border-t-2 border-amber-900/20 pt-8">
                <h3 className="font-display text-2xl font-bold text-red-800 mb-4 tracking-wide border-b-2 border-amber-900/20 pb-2">Virtudes Paladinescas</h3>
                <p className="font-medium mb-4">
                  Este conjunto de poderes representa obediência veemente a um comportamento específico. Você recebe um bônus progressivo em seu total de pontos de mana de acordo com a quantidade de poderes desse tipo que possui: <strong className="text-red-800">+1 PM</strong> para uma Virtude, <strong className="text-red-800">+3 PM</strong> para duas, <strong className="text-red-800">+6 PM</strong> para três, <strong className="text-red-800">+10 PM</strong> para quatro e <strong className="text-red-800">+15 PM</strong> para cinco Virtudes.
                </p>
        ...
        {filteredPowers.length === 0 && (
          <div className="text-center py-20 border-2 border-dashed border-amber-900/30 rounded-xl bg-[rgb(var(--bg-card-rgb))]/50 flex flex-col items-center justify-center mt-8">
            ...
            <p className="font-display text-amber-950/70 text-lg italic tracking-wide">
              Nenhum poder de paladino encontrado.
            </p>
          </div>
        )}
      </main>
