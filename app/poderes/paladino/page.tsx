    ...
    <main className="w-full min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black text-gray-100 px-6 py-12">
      ...
      <header className="p-6 border-b border-purple-900/50">
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          <span className="text-gray-600">/</span>
          <span className="text-gray-400 text-sm">Poderes de Paladino</span>
        </div>
      </header>
      ...
      <div className="mb-12">
        ...
        <p className="text-gray-400 text-lg">Poderes exclusivos da classe Paladino:</p>
      </div>
      ...
      <div className="mt-16 p-8 rounded-xl bg-gradient-to-br from-pink-950/30 to-black border border-yellow-900/30">
        <h3 className="text-2xl font-bold text-purple-300 mb-4">Julgamentos Divinos</h3>
        <p className="text-gray-300 leading-relaxed">Alguns poderes do paladino são Julgamentos Divinos. Esses poderes compartilham as seguintes regras:</p>
        <p className="text-gray-300 leading-relaxed"> - Proferir um julgamento gasta uma ação de movimento, a menos que a descrição diga o contrário.</p>
        <p className="text-gray-300 leading-relaxed"> - Julgamentos que não têm um efeito instantâneo duram até o fim da cena.</p>
        <p className="text-gray-300 leading-relaxed"> - Uma mesma criatura pode ser alvo de vários julgamentos diferentes, mas efeitos do mesmo julgamento não se acumulam.</p>
        </div>

        <div className="mt-16 p-8 rounded-xl bg-gradient-to-br from-pink-950/30 to-black border border-yellow-900/30">
        <h3 className="text-2xl font-bold text-purple-300 mb-4">Virtudes Paladinescas</h3>
        <p className="text-gray-300 leading-relaxed">Este conjunto de poderes representa obediência veemente a um comportamento específico. Você recebe um bônus progressivo em seu total de pontos de mana de acordo com a quantidade de poderes desse tipo que possui: +1 PM para uma Virtude, +3 PM para duas, +6 PM para três, +10 PM para quatro e +15 PM para cinco Virtudes.</p>
        <p className="text-gray-300 leading-relaxed"> Virtudes Paladinescas são poderosas, mas possuem uma contrapartida — você deve se comportar de acordo com quaisquer Virtudes que possuir. Um paladino caridoso, por exemplo, deve sempre ajudar os necessitados, enquanto um casto nunca pode cair em tentação. Não seguir uma Virtude Paladinesca que você possua conta como uma violação do Código do Herói. O mestre tem a palavra final sobre o que exatamente constitui uma violação.</p>
        </div>
