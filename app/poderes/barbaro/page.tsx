          ...
          <div className={`overflow-hidden transition-all duration-500 ease-in-out border-x-2 border-b-2 border-amber-900/30 rounded-b-xl bg-[#fbf5e6] ${isIntroOpen ? 'max-h-[100000px] opacity-100' : 'max-h-0 opacity-0 border-transparent'}`}>
            <div className="p-8 sm:p-10">
              ...
              <div className="space-y-4 text-stone-400 text-sm leading-relaxed font-serif text-justify">
                <h3 className="text-2xl font-bold text-red-800 mb-2 font-serif pb-2">Animais Totêmicos</h3>
                <p className="text-amber-900/90 font-medium mb-4 text-justify"> A seguir está uma lista de animais venerados por tribos bárbaras de Arton.</p>
            <div className="space-y-2 text-amber-900/80 font-serif">
                <p><span className="text-red-800 font-bold">Coruja:</span><span className="font-medium"> A sábia coruja guia seus discípulos. Você pode lançar Orientação. </span></p>
                <p><span className="text-red-800 font-bold">Corvo:</span><span className="font-medium"> Um seguidor do corvo enxerga além do véu. Você pode lançar Visão Mística.</span></p>
                <p><span className="text-red-800 font-bold">Falcão: </span><span className="font-medium">Sempre atento, o falcão permite que você lance Detectar Ameaças.</span></p>
                <p><span className="text-red-800 font-bold">Grifo: </span><span className="font-medium">O mais veloz dos animais, o grifo permite que você lance Primor Atlético.</span></p>
                <p><span className="text-red-800 font-bold">Lobo: </span><span className="font-medium">O lobo é feroz e letal. Você pode lançar Concentração de Combate.</span></p>
                <p><span className="text-red-800 font-bold">Raposa: </span><span className="font-medium">A sagaz raposa nunca está onde se espera. Você pode lançar Imagem Espelhada.</span></p>
                <p><span className="text-red-800 font-bold">Tartaruga: </span><span className="font-medium">A tartaruga protege os seus. Você pode lançar Armadura Arcana.</span></p>
                <p><span className="text-red-800 font-bold">Urso: </span><span className="font-medium">O vigoroso urso permite que você lance Vitalidade Fantasma e possa usar seus aprimoramentos como se tivesse acesso aos mesmos círculos de magia que um druida de seu nível.</span></p>
            </div>
            {/* Seção de Informação (Poderes de Brado) */}
                <div>
                    <h3 className="text-2xl font-bold text-red-800 mb-1 mt-6 font-serif border-t-2 border-amber-900/10 pb-2">Poderes de Brado</h3>
                    <p className="text-amber-900/90 font-medium mb-4 text-serif">Poderes de brado compartilham as seguintes regras:</p>
                
                    <p className="text-amber-900/90 font-medium mb-4 text-serif"><span className="text-red-800 font-bold">•</span><span className="font-medium"> Emitir um brado gasta uma ação de movimento e 1 PM, a menos que a descrição diga o contrário.</span></p>
                    <p className="text-amber-900/90 font-medium mb-4 text-serif"><span className="text-red-800 font-bold">•</span><span className="font-medium"> Brados têm alcance curto.</span></p>
                    <p className="text-amber-900/90 font-medium text-serif">
