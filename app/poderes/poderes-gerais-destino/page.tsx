  ...
  return (
    <div className="min-h-screen bg-[rgb(var(--bg-rgb))] text-amber-950 font-serif selection:bg-amber-800 selection:text-amber-50 relative overflow-x-hidden bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[rgb(var(--bg-rgb))] to-[rgb(var(--bg-edge-rgb))]">
      ...
      <main className="relative z-10 w-full px-6 py-12 max-w-screen-2xl mx-auto">
        ...
        {/* Acordeão de Introdução — CONTEÚDO INALTERADO */}
        <div className="mb-12 w-full">
          ...
          <div className={`overflow-hidden transition-all duration-500 ease-in-out border-x-2 border-b-2 border-amber-900/30 rounded-b-xl bg-[rgb(var(--bg-inset-rgb))] ${isIntroOpen ? 'max-h-[5000px] opacity-100' : 'max-h-0 opacity-0 border-transparent'}`}>
            <div className="p-5 md:p-10 font-serif text-amber-950/85 text-base md:text-lg text-left leading-relaxed flex flex-col gap-10">
              ...
              <section>
                <h3 className="font-display text-2xl font-bold text-red-800 mb-6 text-center tracking-wide border-b-2 border-amber-900/20 pb-2">
                  Tabela de Benefícios - Ao Sabor do Destino
                </h3>

                <div className="overflow-x-auto shadow-sm rounded-xl border-2 border-amber-900/20 bg-[rgb(var(--bg-card-rgb))]">
                  <table className="min-w-full divide-y-2 divide-amber-900/20">
                    <thead className="bg-[rgb(var(--bg-inset-rgb))] text-amber-950/80">
                      <tr>
                        <th className="font-display px-6 py-4 border-r-2 border-amber-900/20 text-center font-bold uppercase tracking-widest text-sm w-1/3">Nível</th>
                        <th className="font-display px-6 py-4 font-bold uppercase tracking-widest text-sm text-left">Benefício</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-amber-900/10 bg-[rgb(var(--bg-inset-rgb))] text-sm md:text-base">
                      {progressionData.map((row, index) => (
                        <tr key={index} className={`transition-colors hover:bg-[rgb(var(--bg-card-rgb))]/50 ${index % 2 === 0 ? '' : 'bg-[rgb(var(--bg-card-rgb))]/30'}`}>
              ...
              <section className="border-t-2 border-amber-900/20 pt-8">
                ...
                <div className="overflow-x-auto shadow-sm rounded-xl border-2 border-amber-900/20 bg-[rgb(var(--bg-card-rgb))]">
                  <table className="min-w-full divide-y-2 divide-amber-900/20">
                    <thead className="bg-[rgb(var(--bg-inset-rgb))] text-amber-950/80">
                      <tr>
                        <th className="font-display px-6 py-4 font-bold uppercase tracking-widest text-sm text-left border-r-2 border-amber-900/20 w-3/4">Benefício</th>
                        <th className="font-display px-6 py-4 text-center font-bold uppercase tracking-widest text-sm w-1/4">CD</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-amber-900/10 bg-[rgb(var(--bg-inset-rgb))] text-sm md:text-base">
          ...
          {filteredPowers.map((power) => (
            ...
            >
              ...
              <div className="flex-1 mb-4">
                <p className="text-amber-950/85 text-sm leading-relaxed text-center whitespace-pre-wrap">
                  {power.description}
                </p>
              </div>
        ...
        {filteredPowers.length === 0 && (
          <div className="text-center py-20 border-2 border-dashed border-amber-900/30 rounded-xl bg-[rgb(var(--bg-card-rgb))]/50 flex flex-col items-center justify-center mt-16">
