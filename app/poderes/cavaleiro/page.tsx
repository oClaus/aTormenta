  ...
  return (
    <main className="w-full min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black text-gray-100 px-6 py-12">
      ...
      <div className="mt-16 p-8 rounded-xl bg-gradient-to-br from-pink-950/30 to-black border border-yellow-900/30">
        <h3 className="text-2xl font-bold text-purple-300 mb-4">Posturas de Combate</h3>
        <p className="text-gray-300 leading-relaxed">Alguns poderes do cavaleiro são Posturas de Combate. Esses poderes compartilham as seguintes regras:</p>
        <p className="text-gray-300 leading-relaxed"> - Assumir uma postura gasta uma ação de movimento e 2 PM.</p>
        <p className="text-gray-300 leading-relaxed"> - Os efeitos de uma postura duram até o final da cena, a menos que sua descrição diga o contrário.</p>
        <p className="text-gray-300 leading-relaxed"> - Você só pode manter uma postura por vez.</p>
        </div>
