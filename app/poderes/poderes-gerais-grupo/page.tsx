...
export default function GeraisGrupoPowersPage() {
        ...
        <div className="w-full px-4 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-3 self-end md:self-auto">
            <div className="font-display flex items-center gap-2 flex-wrap text-xs sm:text-sm font-bold tracking-widest uppercase">
              ...
              <span className="text-amber-900/40">/</span>
              <span className="text-red-800 whitespace-nowrap">Grupo</span>
            </div>
            <ThemeToggle />
          </div>
        </div>
      ...
      <main className="relative z-10 w-full px-6 py-12 max-w-screen-2xl mx-auto">
        ...
        <div className="mb-10 md:mb-12 w-full flex flex-col items-start">
          ...
          <p className="text-amber-950/85 text-lg font-medium max-w-3xl leading-relaxed">
            Acervo de poderes desenvolvidos com base em cooperação e táticas conjuntas.
          </p>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <h2 className="font-display text-xl font-bold text-amber-950 group-hover:text-red-800 transition-colors uppercase tracking-wide">
                  Regras de Poderes de Grupo
                </h2>
                <p className="text-sm text-amber-950/70 italic font-bold">
                  Clique para expandir informações sobre funcionamento, condições e jogadores ausentes.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 md:p-10 font-serif text-amber-950/85 text-base md:text-lg text-left md:text-justify leading-relaxed flex flex-col gap-6">
              ...
              <section>
                <p className="font-medium mb-4">
                  Poderes de grupo fornecem bônus maiores que outros poderes; contudo, <strong className="text-red-800">só funcionam se houver outro personagem com o mesmo poder na cena</strong>. Assim, se apenas você comprar um poder de grupo, ele não terá efeito!
                </p>
                <p className="font-medium mb-4">
                  Muitas vezes, poderes de grupo se tornam mais eficientes de acordo com o número de personagens com o mesmo poder na cena. O pré-requisito de ter um aliado com o mesmo poder na cena nunca pode ser cumprido por NPCs, parceiros e outros coadjuvantes — apenas por personagens jogadores. Também não pode ser cumprido por efeitos que permitam a um personagem usar um poder sem possuí-lo. Em suma, funcionam apenas se dois ou mais membros do grupo efetivamente tiverem escolhido o poder.
                </p>
                <p className="font-medium">
                  Caso um membro do grupo morra e um poder de grupo fique inativo, você pode gastar tempo entre aventuras para treinar e trocar o poder, ou esperar que o jogador em questão faça outro personagem com o mesmo poder de grupo.
                </p>
              </section>

              <section className="border-t-2 border-amber-900/20 pt-6 mt-2">
                <h3 className="font-display text-2xl md:text-3xl font-bold text-red-800 mb-4 tracking-wide border-b-2 border-amber-900/10 pb-2">O Dilema do Jogador Ausente</h3>
                <p className="font-medium mb-4">
