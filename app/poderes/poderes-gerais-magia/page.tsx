...
import { powersGeraisMagia } from "@/data/powers-gerais-magia"; // Verifique se este caminho está correto no seu projeto
    ...
    <main className="w-full min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black text-gray-100 px-6 py-12">
      ...
      <header className="p-6 border-b border-purple-900/50 mb-12">
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          <span className="text-gray-600">/</span>
          <span className="text-gray-400 text-sm">Poderes Gerais - Magia</span>
        </div>
      </header>
      ...
      <div className="mb-12">
        ...
        <h1 className="text-1xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 mb-4">
