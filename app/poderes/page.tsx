          ...
          <div className={`overflow-hidden transition-all duration-500 ease-in-out border-x-2 border-b-2 border-amber-900/30 rounded-b-xl bg-[rgb(var(--bg-inset-rgb))] ${isIntroOpen ? 'max-h-[3000px] opacity-100' : 'max-h-0 opacity-0 border-transparent'}`}>
            <div className="p-5 md:p-10 font-serif text-amber-950/85 text-base md:text-lg text-left md:text-justify leading-relaxed flex flex-col gap-8">
              ...
              <section className="border-t-2 border-amber-900/20 pt-8">
                <h3 className="font-display text-2xl md:text-3xl font-bold text-red-800 mb-4 tracking-wide border-b-2 border-amber-900/10 pb-2">
              ...
              <section className="border-t-2 border-amber-900/20 pt-8">
                ...
                <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                        ...
                        <span className="font-medium"><strong className="font-display text-red-800 uppercase tracking-widest text-sm bg-[rgb(var(--bg-card-rgb))] px-2 py-1 rounded shadow-sm border border-amber-900/10 mr-2 inline-block mb-1 md:mb-0">Combate:</strong> Poderes que melhoram características relacionadas a combate.</span>
                    </li>
                    <li className="flex items-start gap-3">
                        <span className="text-[10px] text-red-800/60 mt-2">◆</span>
                        <span className="font-medium"><strong className="font-display text-red-800 uppercase tracking-widest text-sm bg-[rgb(var(--bg-card-rgb))] px-2 py-1 rounded shadow-sm border border-amber-900/10 mr-2 inline-block mb-1 md:mb-0">Destino:</strong> Poderes que melhoram características não relacionadas a combate.</span>
                    </li>
                    <li className="flex items-start gap-3">
                        <span className="text-[10px] text-red-800/60 mt-2">◆</span>
                        <span className="font-medium"><strong className="font-display text-red-800 uppercase tracking-widest text-sm bg-[rgb(var(--bg-card-rgb))] px-2 py-1 rounded shadow-sm border border-amber-900/10 mr-2 inline-block mb-1 md:mb-0">Magia:</strong> Poderes ligados a magias e itens mágicos.</span>
                    </li>
                    <li className="flex items-start gap-3">
                        <span className="text-[10px] text-red-800/60 mt-2">◆</span>
                        <span className="font-medium"><strong className="font-display text-red-800 uppercase tracking-widest text-sm bg-[rgb(var(--bg-card-rgb))] px-2 py-1 rounded shadow-sm border border-amber-900/10 mr-2 inline-block mb-1 md:mb-0">Concedidos:</strong> Poderes recebidos por devotos.</span>
                    </li>
                    <li className="flex items-start gap-3">
                        <span className="text-[10px] text-red-800/60 mt-2">◆</span>
                        <span className="font-medium"><strong className="font-display text-red-800 uppercase tracking-widest text-sm bg-[rgb(var(--bg-card-rgb))] px-2 py-1 rounded shadow-sm border border-amber-900/10 mr-2 inline-block mb-1 md:mb-0">Tormenta:</strong> Poderes ligados à tempestade rubra.</span>
                    </li>
                    <li className="flex items-start gap-3">
                        <span className="text-[10px] text-red-800/60 mt-2">◆</span>
                        <span className="font-medium"><strong className="font-display text-red-800 uppercase tracking-widest text-sm bg-[rgb(var(--bg-card-rgb))] px-2 py-1 rounded shadow-sm border border-amber-900/10 mr-2 inline-block mb-1 md:mb-0">Raça:</strong> São caracterizados por possuírem como pré-requisito pertencer a uma raça específica.</span>
                    </li>
                    <li className="flex items-start gap-3">
                        <span className="text-[10px] text-red-800/60 mt-2">◆</span>
                        <span className="font-medium"><strong className="font-display text-red-800 uppercase tracking-widest text-sm bg-[rgb(var(--bg-card-rgb))] px-2 py-1 rounded shadow-sm border border-amber-900/10 mr-2 inline-block mb-1 md:mb-0">Grupo:</strong> Poderes de grupo fornecem bônus maiores que outros poderes; contudo, só funcionam se houver outro personagem com o mesmo poder na cena.</span>
                    </li>
                </ul>
              </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-x-6 gap-y-10 items-stretch">
            ...
            >
                ...
                <div className="relative z-10 flex flex-col h-full">
                    <h3 className="font-display text-lg font-bold text-amber-950 mt-2 mb-3 tracking-wide text-center">
                        {category.name}
                    </h3>
                    <div className="flex-1 mb-4">
                        <p className="text-amber-950/70 leading-relaxed text-sm text-center">
                            {category.description}
                        </p>
                    </div>
                    <div className="relative flex items-center justify-center pt-4 border-t border-amber-900/15 group-hover:border-[rgb(var(--accent-rgb))]/30 transition-colors">
