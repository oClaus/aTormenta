...
export default function GeraisRacaPowersPage() {
        ...
        <div className="w-full px-4 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-3 self-end md:self-auto">
            <div className="font-display flex items-center gap-2 flex-wrap text-xs sm:text-sm font-bold tracking-widest uppercase">
              ...
              <span className="text-amber-900/40">/</span>
              <span className="text-red-800 whitespace-nowrap">Raça</span>
            </div>
            <ThemeToggle />
          </div>
        </div>
      ...
      <main className="relative z-10 w-full px-6 py-12 max-w-screen-2xl mx-auto">
        ...
        <div className="mb-10 md:mb-12 w-full flex flex-col items-start">
          ...
          <p className="text-amber-950/85 text-lg font-medium max-w-3xl leading-relaxed">
            Acervo de dons e capacidades ligadas à ancestralidade e herança sanguínea.
          </p>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <h2 className="font-display text-xl font-bold text-amber-950 group-hover:text-red-800 transition-colors uppercase tracking-wide">
                  Regras de Poderes de Raça
                </h2>
                <p className="text-sm text-amber-950/70 italic font-bold">
                  Clique para expandir as definições sobre aquisição de dons raciais.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 md:p-10 font-serif text-amber-950/85 text-base md:text-lg text-left md:text-justify leading-relaxed flex flex-col gap-6">
              <section>
                <p className="font-medium">
                  Poderes de raça são um novo grupo de poderes gerais. São caracterizados por possuírem como pré-requisito pertencer a uma raça específica. Exceto por isso, funcionam como quaisquer outros poderes gerais e devem ser adquiridos seguindo as regras normais de avanço de nível.
                </p>
              </section>
            </div>
          </div>
        ...
        {filteredPowers.length === 0 && (
          <div className="text-center py-20 border-2 border-dashed border-amber-900/30 rounded-xl bg-[rgb(var(--bg-card-rgb))]/50 flex flex-col items-center justify-center mt-8">
            ...
            <p className="font-display text-amber-950/70 text-lg italic tracking-wide">
              Nenhum poder de raça encontrado com o termo aplicado.
            </p>
          </div>
        )}
      </main>
