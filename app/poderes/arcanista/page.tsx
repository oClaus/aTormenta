        ...
        <div className="mb-12 w-full">
          ...
          <div className={`overflow-hidden transition-all duration-500 ease-in-out border-x-2 border-b-2 border-amber-900/30 rounded-b-xl bg-[rgb(var(--bg-inset-rgb))] ${isIntroOpen ? 'max-h-[3000px] opacity-100' : 'max-h-0 opacity-0 border-transparent'}`}>
            <div className="p-5 md:p-10 font-serif text-amber-950/85 text-base md:text-lg text-left md:text-justify leading-relaxed flex flex-col gap-8">
              ...
              <section>
                <h3 className="font-display text-2xl font-bold text-red-800 mb-4 tracking-wide border-b-2 border-amber-900/20 pb-2">Familiares Arcanos</h3>
                ...
                <div className="space-y-4 pl-4 md:pl-5 border-l-4 border-amber-900/30 text-base md:text-lg text-left">
                  <p><span className="text-red-800 font-bold uppercase tracking-wide text-sm">Borboleta: </span><span className="font-medium">A CD dos testes de Vontade para resistir a suas magias aumenta em +1.</span></p>
                  <p><span className="text-red-800 font-bold uppercase tracking-wide text-sm">Cobra: </span><span className="font-medium">A CD dos testes de Fortitude para resistir a suas magias aumenta em +1.</span></p>
                  <p><span className="text-red-800 font-bold uppercase tracking-wide text-sm">Coruja: </span><span className="font-medium">Quando lança uma magia com alcance de toque, você pode pagar 1 PM para aumentar seu alcance para curto.</span></p>
                  <p><span className="text-red-800 font-bold uppercase tracking-wide text-sm">Corvo: </span><span className="font-medium">Quando faz um teste de Misticismo ou Vontade, você pode pagar 1 PM para rolar dois dados e usar o melhor resultado.</span></p>
                  <p><span className="text-red-800 font-bold uppercase tracking-wide text-sm">Falcão: </span><span className="font-medium">Você não pode ser surpreendido e nunca fica desprevenido.</span></p>
                  <p><span className="text-red-800 font-bold uppercase tracking-wide text-sm">Gato: </span><span className="font-medium">Você recebe visão no escuro e +2 em Furtividade.</span></p>
                  <p><span className="text-red-800 font-bold uppercase tracking-wide text-sm">Lagarto: </span><span className="font-medium">A CD dos testes de Reflexos para resistir a suas magias aumenta em +1.</span></p>
                  ...
                  <p><span className="text-red-800 font-bold uppercase tracking-wide text-sm">Estirge: </span><span className="font-medium">Um estirge pode ser invocado como familiar, mas isso requer uma ova de estirge. Um estirge familiar permite que você receba 1 PV temporário cumulativo (até o limite de seu nível) sempre que causa dano a uma criatura viva com uma magia.</span></p>
                  <p><span className="text-red-800 font-bold uppercase tracking-wide text-sm">Chibi-Kabuto: </span><span className="font-medium">Um chibi-kabuto familiar aumenta em +1 o bônus na Defesa que você recebe por suas magias.</span></p>
              ...
              <section>
                <h3 className="font-display text-2xl font-bold text-red-800 mb-4 tracking-wide border-b-2 border-amber-900/20 pb-2">Familiares Elementais</h3>
                <p className="font-medium mb-6">
        ...
        {filteredPowers.length === 0 && (
          <div className="text-center py-20 border-2 border-dashed border-amber-900/30 rounded-xl bg-[rgb(var(--bg-card-rgb))]/50 flex flex-col items-center justify-center mt-8">
            ...
            <p className="font-display text-amber-950/70 text-lg italic tracking-wide">
              Nenhum poder arcanista encontrado.
            </p>
          </div>
        )}
      </main>
