  ...
  return (
    <main className="w-full min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black text-gray-100 px-6 py-12">
      ...
      <div className="mb-12">
        ...
        <p className="text-gray-400 text-lg">Poderes de Clérigo:</p>
      </div>
      ...
      <div className="mt-16 p-8 rounded-xl bg-gradient-to-br from-pink-950/30 to-black border border-yellow-900/30">
        <h3 className="text-2xl font-bold text-purple-300 mb-4">Missas</h3>
        <p className="text-gray-300 leading-relaxed">Alguns poderes do clérigo são Missas. Esses poderes compartilham as seguintes regras:</p>
        <p className="text-gray-300 leading-relaxed"> - Rezar uma Missa exige uma hora e o gasto de materiais especiais (como velas, incensos, água benta...) no valor de T$ 25. Um mesmo celebrante pode aplicar mais de um poder de Missa na mesma celebração. Cada poder adicional aumenta o custo da Missa em T$ 25.</p>
        <p className="text-gray-300 leading-relaxed"> - Uma Missa afeta um número máximo de pessoas igual a 1 + sua Sabedoria. Todas as pessoas precisam estar presentes durante toda a Missa.</p>
        <p className="text-gray-300 leading-relaxed"> - Os efeitos de uma Missa duram um dia. Uma mesma criatura só pode receber os benefícios da mesma Missa uma vez por dia.</p>
        </div>
