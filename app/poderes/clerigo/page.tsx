      ...
      <header className="relative z-10 w-full p-6 border-b-4 border-double border-amber-900/40 bg-[#e6d5b8]/90 backdrop-blur-md shadow-sm mb-8 md:mb-12 sticky top-0">
        <div className="w-full px-4 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 flex-wrap text-xs sm:text-sm font-bold tracking-wide uppercase self-end md:self-auto">
                ...
                <span className="text-amber-900/40">/</span>
                <span className="text-red-800">Poderes de Clérigo</span>
            </div>
        </div>
      </header>
          ...
          <div className={`overflow-hidden transition-all duration-500 ease-in-out border-x-2 border-b-2 border-amber-900/30 rounded-b-xl bg-[#fbf5e6] ${isIntroOpen ? 'max-h-[100000px] opacity-100' : 'max-h-0 opacity-0 border-transparent'}`}>
            <div className="p-8 sm:p-10">          
                <div className="space-y-4 text-stone-400 text-sm leading-relaxed font-serif text-justify">
                    <h3 className="text-2xl font-bold text-red-800 mb-1 font-serif pb-2">Missas</h3>
                    <p className="text-amber-900/90 font-medium mb-4 text-serif">Alguns poderes do clérigo são Missas. Esses poderes compartilham as seguintes regras:</p>
                
                    <p className="text-amber-900/90 font-medium mb-4 text-serif"><span className="text-red-800 font-bold">•</span><span className="font-medium"> Rezar uma Missa exige uma hora e o gasto de materiais especiais (como velas, incensos, água benta...) no valor de T$ 25. Um mesmo celebrante pode aplicar mais de um poder de Missa na mesma celebração. Cada poder adicional aumenta o custo da Missa em T$ 25.</span></p>
                    <p className="text-amber-900/90 font-medium mb-4 text-serif"><span className="text-red-800 font-bold">•</span><span className="font-medium"> Uma Missa afeta um número máximo de pessoas igual a 1 + sua Sabedoria. Todas as pessoas precisam estar presentes durante toda a Missa.</span></p>
                    <p className="text-amber-900/90 font-medium mb-4 text-serif"><span className="text-red-800 font-bold">•</span><span className="font-medium"> Os efeitos de uma Missa duram um dia. Uma mesma criatura só pode receber os benefícios da mesma Missa uma vez por dia.</span></p>
                </div>

                <div className="space-y-4 text-stone-400 text-sm leading-relaxed font-serif text-justify">
                    <h3 className="text-2xl font-bold text-red-800 mb-1 font-serif border-t-2 border-amber-900/10 pb-2">Mestre Celebrante</h3>
                    <p className="text-amber-900/90 font-medium mb-4 text-serif">O poder <span className="text-red-800 font-semibold">Mestre Celebrante</span> dobra os benefícios de Missas celebradas pelo personagem. Abaixo detalhamos como isso se aplica às novas missas:</p>
                
                    <p className="text-amber-900/90 font-medium mb-4 text-serif"><span className="text-red-800 font-bold">•</span><span className="font-medium"> Se a Missa fornece um bônus numérico que se aplica por toda sua duração, como o de <span className="italic text-red-500">Mente Abençoada</span>, esse bônus é dobrado.</span></p>
                    <p className="text-amber-900/90 font-medium mb-4 text-serif"><span className="text-red-800 font-bold">•</span><span className="font-medium"> Se fornece uma quantidade de PV ou PM, como <span className="italic text-red-500">Elevação do Espírito</span>, essa quantidade é dobrada.</span></p>
                    <p className="text-amber-900/90 font-medium mb-4 text-serif"><span className="text-red-800 font-bold">•</span><span className="font-medium"> Se permite usar uma habilidade ou receber um benefício uma vez, como <span className="italic text-red-500">Compartilhar Milagre</span>, esse efeito pode ser usado uma vez adicional pela duração da Missa.</span></p>
                </div>
            </div>
          </div>
        </div>
