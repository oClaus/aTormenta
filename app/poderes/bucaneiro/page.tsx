          ...
          <div className={`overflow-hidden transition-all duration-500 ease-in-out border-x-2 border-b-2 border-amber-900/30 rounded-b-xl bg-[#fbf5e6] ${isIntroOpen ? 'max-h-[100000px] opacity-100' : 'max-h-0 opacity-0 border-transparent'}`}>
            ...
            {/* Texto das Bravatas */}
                <div className="space-y-4 text-stone-400 text-sm leading-relaxed font-serif text-justify">
                    <h3 className="text-2xl font-bold text-red-800 mb-2 font-serif pb-2">Bravatas</h3>
                    <p className="text-amber-900/90 font-medium mb-4 text-justify">Audazes e imprudentes, bucaneiros têm o costume da bravata — a promessa pública de realizar uma façanha, às vezes atrelada a uma restrição, como “Navegarei até Galrasia com um barco furado!”. Todas as Bravatas compartilham as seguintes regras:</p>
                </div>
                <div className="space-y-4 text-amber-900/90 text-sm leading-relaxed font-serif text-justify">
                    <p className="leading-relaxed"><span className="text-red-800 font-bold">•</span> Uma Bravata deve envolver um desafio real. Em termos de jogo, deve ser uma ação com ND igual ou maior que o nível do bucaneiro.</p>
                    <p className="leading-relaxed"><span className="text-red-800 font-bold">•</span> Você só pode ter uma Bravata de cada tipo ativa por vez. Caso falhe em uma Bravata ou desista dela, você perde todos os seus PM e só pode recuperá-los a partir do próximo dia.</p>
                    <p className="leading-relaxed"><span className="text-red-800 font-bold">•</span> Quando você cumpre uma Bravata, recebe um benefício que dura até o fim da aventura. De acordo com o mestre, caso isso aconteça perto do fim da aventura, o benefício pode se estender até a próxima.</p>
                </div>

            {/* TABELA 1-17: INTRODUÇÃO CALOROSA */}
            <div className="space-y-4 text-amber-900/90 text-sm leading-relaxed font-serif text-justify">
                <h4 className="text-2xl font-bold text-red-800 mb-1 mt-6 font-serif border-t-2 border-amber-900/10 pb-2">
                    Tabela Introdução Calorosa
                </h4>
                
                <div className="overflow-x-auto rounded-xl border-2 border-amber-900/30 shadow-sm">
                <table className="w-full text-left border-collapse text-sm">
                    <thead className="bg-[#e6d5b8] text-amber-900 font-bold uppercase tracking-wider text-xs">
                        <tr>
                            <th className="p-4 font-bold border-b-2 border-amber-900/30">Apresentação</th>
                            <th className="p-4 font-bold border-b-2 border-amber-900/30">Ação</th>
                            <th className="p-4 font-bold border-b-2 border-amber-900/30">Benefício</th>
                            <th className="p-4 font-bold border-b-2 border-amber-900/30">Exemplo</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-amber-900/10 bg-[#fffbf2] font-serif text-amber-950/90">
                        <tr className="hover:bg-amber-100 transition-colors bg-[#fffbf2]">
                            <td className="p-4 font-medium text-amber-950">Saudação educada</td>
                            <td className="p-4">Livre</td>
                            <td className="p-4">1 PM temporário</td>
                            <td className="p-4 italic text-amber-900/70">“Olá!”</td>
                        </tr>
                        <tr className="hover:bg-amber-100 transition-colors bg-[#f9f2e0]">
                            <td className="p-4 font-medium text-amber-950">Apresentar o próprio nome</td>
                            <td className="p-4">Movimento</td>
                            <td className="p-4">+2 em perícias baseadas em Carisma</td>
                            <td className="p-4 italic text-amber-900/70">“Meu nome é Lorthan.”</td>
                        </tr>
                        <tr className="hover:bg-amber-100 transition-colors bg-[#fffbf2]">
                            <td className="p-4 font-medium text-amber-950">Declarar uma ligação pessoal</td>
                            <td className="p-4">Padrão</td>
                            <td className="p-4">+2 em rolagens de dano</td>
                            <td className="p-4 italic text-amber-900/70">“Vocês roubaram a colheita dos camponeses.”</td>
                        </tr>
                        <tr className="hover:bg-amber-100 transition-colors bg-[#f9f2e0]">
                            <td className="p-4 font-medium text-amber-950">Revelar seu objetivo na cena</td>
                            <td className="p-4">Completa</td>
                            <td className="p-4">Pode rolar novamente um único teste de perícia recém-feito</td>
                            <td className="p-4 italic text-amber-900/70">“Eu vim aqui para puni-los!”</td>
                        </tr>
                    </tbody>
                </table>
            </div>
