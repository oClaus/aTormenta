        ...
        <div className="mb-12 w-full">
          ...
          <div className={`overflow-hidden transition-all duration-500 ease-in-out border-x-2 border-b-2 border-amber-900/30 rounded-b-xl bg-[rgb(var(--bg-inset-rgb))] ${isIntroOpen ? 'max-h-[3000px] opacity-100' : 'max-h-0 opacity-0 border-transparent'}`}>
            <div className="p-5 md:p-10 font-serif text-amber-950/85 text-base md:text-lg text-left md:text-justify leading-relaxed flex flex-col gap-8">
              ...
              {/* Seção 1: Bravatas */}
              <section>
                <h3 className="font-display text-2xl font-bold text-red-800 mb-4 tracking-wide border-b-2 border-amber-900/20 pb-2">Bravatas</h3>
              ...
              {/* Seção 2: TABELA 1-17: INTRODUÇÃO CALOROSA */}
              <section className="border-t-2 border-amber-900/20 pt-8">
                <h4 className="font-display text-xl md:text-2xl font-bold text-red-800 mb-4 tracking-wide">
                ...
                <div className="overflow-x-auto shadow-sm rounded-xl border-2 border-amber-900/20 bg-[rgb(var(--bg-card-rgb))]">
                  <table className="min-w-full divide-y-2 divide-amber-900/20">
                    <thead className="bg-[rgb(var(--bg-inset-rgb))] text-amber-950/80">
                      <tr>
                        <th className="font-display px-4 py-3 text-left text-xs md:text-sm font-bold uppercase tracking-widest border-r-2 border-amber-900/20">Apresentação</th>
                        <th className="font-display px-4 py-3 text-left text-xs md:text-sm font-bold uppercase tracking-widest border-r-2 border-amber-900/20">Ação</th>
                        <th className="font-display px-4 py-3 text-left text-xs md:text-sm font-bold uppercase tracking-widest border-r-2 border-amber-900/20">Benefício</th>
                    ...
                    <tbody className="divide-y divide-amber-900/10 bg-[rgb(var(--bg-inset-rgb))] text-sm md:text-base">
                      ...
                      <tr className="bg-[rgb(var(--bg-card-rgb))]/30 hover:bg-[rgb(var(--bg-card-rgb))]/50 transition-colors">
