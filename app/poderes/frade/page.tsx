...
export default function FradePowersPage() {
        ...
        <div className="w-full px-4 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-3 self-end md:self-auto">
            <div className="font-display flex items-center gap-2 flex-wrap text-xs sm:text-sm font-bold tracking-widest uppercase">
              ...
              <span className="text-amber-900/40">/</span>
              <span className="text-red-800 whitespace-nowrap">Frade</span>
            </div>
            <ThemeToggle />
          </div>
        </div>
      ...
      <main className="relative z-10 w-full px-6 py-12 max-w-screen-2xl mx-auto">
        ...
        <div className="mb-10 md:mb-12 w-full flex flex-col items-start">
          ...
          <p className="text-amber-950/85 text-lg font-medium max-w-3xl leading-relaxed">
            Acervo de poderes e habilidades exclusivas da classe Frade.
          </p>
        </div>

        {/* Acordeão de Regras — CONTEÚDO INALTERADO */}
        <div className="mb-12 w-full">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-amber-950/70 italic font-bold">
                  Clique para expandir as regras de funcionamento dos Sacrários.
                </p>
              </div>
            </div>
          ...
          <div className={`overflow-hidden transition-all duration-500 ease-in-out border-x-2 border-b-2 border-amber-900/30 rounded-b-xl bg-[rgb(var(--bg-inset-rgb))] ${isIntroOpen ? 'max-h-[8000px] opacity-100' : 'max-h-0 opacity-0 border-transparent'}`}>
            <div className="p-5 md:p-10 font-serif text-amber-950/85 text-base md:text-lg text-left md:text-justify leading-relaxed flex flex-col gap-6">
              <section>
                <h3 className="font-display text-2xl md:text-3xl font-bold text-red-800 mb-4 tracking-wide border-b-2 border-amber-900/10 pb-2">Sacrários</h3>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="font-medium">Criar um sacrário gasta uma <strong className="text-red-800">ação padrão e 3 PM</strong>.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[10px] text-red-800/60 mt-2">◆</span>
                    <span className="font-medium">Um sacrário ocupa uma esfera de <strong className="text-red-800">3m de raio em alcance curto</strong>.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[10px] text-red-800/60 mt-2">◆</span>
                    <span className="font-medium">Um sacrário <strong className="text-red-800">dura até o fim da cena</strong>, a menos que sua descrição diga o contrário.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[10px] text-red-800/60 mt-2">◆</span>
                    <span className="font-medium">Você pode ter um número de sacrários ativos simultâneos igual à sua <strong className="text-red-800">Sabedoria</strong>.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[10px] text-red-800/60 mt-2">◆</span>
                    <span className="font-medium">Um sacrário não pode ser criado em uma área afetada por outro sacrário ou onde haja um símbolo visível de uma divindade diferente da sua.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-[10px] text-red-800/60 mt-2">◆</span>
                    <span className="font-medium">Para ser afetada, uma criatura precisa estar <strong className="text-red-800">inteiramente dentro da área</strong> do sacrário.</span>
                  </li>
                </ul>
              </section>
            </div>
        ...
        {/* Busca */}
        <div className="mb-12 p-6 rounded-xl bg-[rgb(var(--bg-card-rgb))] border-2 border-amber-900/30 shadow-[inset_0_2px_10px_rgba(0,0,0,0.05)] font-serif w-full">
