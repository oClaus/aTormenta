...
// Componente para a Tabela Filtrável de Equipamentos
    ...
    <div className="space-y-6 w-full relative">
      ...
      <div className="mb-12 p-6 rounded-xl bg-[rgb(var(--bg-card-rgb))] border-2 border-amber-900/30 shadow-[inset_0_2px_10px_rgba(0,0,0,0.05)]">
        ...
        <div className="relative">
          <input
            type="text"
            placeholder="Buscar equipamento por nome, descrição ou origem..."
            value={searchTerm}
        ...
        <div className="w-full px-4 flex flex-col md:flex-row justify-between items-center gap-4 max-w-screen-2xl mx-auto">
            ...
            <div className="flex items-center gap-3 self-end md:self-auto">
              <div className="font-display flex items-center gap-2 flex-wrap text-xs sm:text-sm font-bold tracking-widest uppercase">
                  ...
                  <span className="text-amber-900/40">/</span>
                  <span className="text-red-800">Equipamentos de Aventura</span>
              </div>
              <ThemeToggle />
            </div>
        </div>
      ...
      <main className="relative z-10 w-full px-6 py-12 max-w-screen-2xl mx-auto">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-amber-950/70 italic font-bold">
                  Clique para expandir informações sobre fabricação e uso.
                </p>
              </div>
            </div>
              ...
              <section>
                ...
                <div className="mt-6 p-6 bg-[rgb(var(--bg-card-rgb))]/50 rounded-xl border border-amber-900/20 shadow-sm border-l-4 border-l-red-800">
                    <p className="font-bold text-amber-950 italic">
                        A CD para fabricar qualquer um desses itens é <span className="text-red-800 text-xl not-italic">15</span>.
                    </p>
                </div>
              </section>
        ...
        <section className="w-full">
            <h2 className="font-display text-3xl font-bold text-red-800 mb-6 flex items-center gap-3 tracking-wide">
                <span className="text-red-800 text-3xl">❖</span> Acervo
            </h2>
