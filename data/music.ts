...
export const music: Gear[] = [
  ...
  {
    id: "citara-heptatonica",
    name: "Cítara Heptatônica",
    description: "Um instrumento peculiar, com som misterioso, que gera uma atmosfera mística. Criaturas a sua escolha sob efeito de sua Inspiração recebem +2 na CD da primeira habilidade mágica que usarem.",
    origin: "Herois de Arton",
    price: "T$ 250",
    spaces: "1"
  },
  {
    id: "cornamusa-de-doherimm",
  ...
  },
  {
    ...
    description: "Um instrumento difícil de ser dominado, usado pelos bardos mais habilidosos. Ver um mestre violinista em ação é um grande incentivo ao virtuosismo em qualquer área. Cada criatura a sua escolha sob efeito de sua Inspiração recebe um bônus adicional de +1d4 em seu próximo teste de perícia (exceto testes de ataque).",
    origin: "Herois de Arton",
    price: "T$ 300",
    spaces: "1"
  },
  {
    id: "Trombeta do Cruzado",
