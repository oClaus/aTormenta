...
import { creatureSizeTable, creatureSizeTableFootnote } from "@/data/caracteristicas";
      ...
      <tbody className="divide-y divide-amber-900/10">
        {data.map((row, index) => (
          <tr key={row.category} className={index % 2 === 0 ? "bg-[rgb(var(--bg-inset-rgb))]" : "bg-[rgb(var(--bg-card-rgb))]/40 hover:bg-[rgb(var(--bg-card-rgb))]/70 transition-colors"}>
            ...
            <td className="px-4 py-2 text-amber-950 font-bold font-mono">{row.stealthAndManeuverModifier}</td>
          </tr>
        ))}
      </tbody>
    </table>
  ...
  { id: "habilidades-completo",
    ...
    content: (
      <>
        ...
        <blockquote className="border-l-4 border-amber-900/30 pl-4 italic my-2 text-sm text-amber-900/80 font-medium">
        ...
        <ul className="list-disc ml-6 space-y-2 mt-2">
          ...
          <li><strong>Cena.</strong> A habilidade dura uma cena inteira, encerrando-se quando esse momento da história acaba. Uma cena não tem medida fixa: pode ser algumas rodadas (um combate), alguns minutos (uma conversa), horas (atravessar um bosque) ou até dias (uma viagem sem incidentes).</li>
          <li><strong>Sustentada.</strong> A habilidade precisa de um fluxo constante de mana. O personagem deve gastar 1 PM como ação livre no início de cada turno para manter o efeito ativo. Se não o fizer, a habilidade termina. É possível manter várias habilidades sustentadas, pagando o custo de cada uma, mas apenas uma magia sustentada por vez.</li>
          <li><strong>Definida.</strong> A duração pode ser medida em rodadas, horas, dias ou outra unidade de tempo.</li>
          <li><strong>Permanente.</strong> A habilidade fica ativa para sempre, mas ainda pode ser encerrada de outras formas.</li>
        </ul>
        <p><strong>Duração e Áreas.</strong> Caso a habilidade afete uma área, seus efeitos permanecem nessa área pela sua duração. Criaturas e objetos válidos que entrem na área são afetados, deixando de sê-lo quando saem.</p>
        <p><strong>Descarregar.</strong> Algumas habilidades duram até serem ativadas e descarregadas. A habilidade permanece “dormente” até que determinado evento aconteça, quando é ativada e descarregada, ou até que sua duração transcorra.</p>
        ...
        <blockquote className="border-l-4 border-red-800 pl-4 italic text-sm text-amber-900/80 my-2">
          Exemplo: A habilidade <strong>Presença Aristocrática</strong>, do nobre, tem CD baseada em Carisma. Para Marsha Yleus, uma humana nobre de 10º nível com Carisma 4, a CD para resistir é 19 (10 + 5 + 4).
        </blockquote>
        <ul className="list-disc ml-6 space-y-2 mt-2">
          <li><strong>Anula.</strong> A habilidade não tem efeito sobre um alvo que passe no teste.</li>
          <li><strong>Parcial.</strong> O efeito é menor em um alvo que passe no teste.</li>
          <li><strong>Reduz à Metade.</strong> O efeito é reduzido à metade em um alvo que passe no teste.</li>
          <li><strong>Desacredita.</strong> Termo específico para ilusões. Se uma criatura interagir com a ilusão (examinando ou tocando), tem direito a um teste para perceber que não é real. A ilusão continua funcionando mesmo que seja percebida; a criatura pode avisar aliados como ação livre, permitindo que eles façam testes para desacreditar.</li>
        </ul>
        <p><strong>Objetos e Dano.</strong> A menos que a descrição diga o contrário, itens carregados não sofrem dano por habilidades. Objetos soltos sofrem dano se a habilidade puder afetar objetos ou áreas.</p>
  ...
  { id: "combate-completo",
    ...
    content: (
      <>
        ...
        <p>Este é um tipo específico de teste de perícia, para acertar um alvo com um ataque. Normalmente é um teste de <strong>Luta</strong>, para um ataque corpo a corpo, ou de <strong>Pontaria</strong>, para um ataque à distância.</p>
        <p>A dificuldade do teste é a <strong>Defesa</strong> do alvo. Se o resultado é igual ou maior que a Defesa, você acerta e causa dano. Um teste de ataque pode sofrer modificadores por habilidades, arma e condições.</p>

        <h4 className="mt-4 font-bold text-red-800">Dano</h4>
        <p>Quando você acerta um ataque, causa dano. Esse dano reduz os pontos de vida do inimigo. Você rola dados para descobrir quanto dano causou. O tipo de dado depende da arma ou ataque utilizado — por exemplo, <strong>1d4</strong> para uma adaga ou <strong>1d8</strong> para uma espada longa.</p>
        ...
        <blockquote className="border-l-4 border-red-800 pl-4 italic text-sm text-amber-900/80 my-2 font-medium">
        ...
        <h4 className="mt-4 font-bold text-red-800">Tipos de Dano</h4>
        <p>Cada arma ou efeito que causa dano possui um tipo. Por si só, o tipo não possui efeito em regras, mas indica a relação do dano com outros efeitos.</p>
        <ul className="list-disc ml-6 space-y-1 mt-2">
        ...
        <h4 className="mt-4 font-bold text-red-800">Acertos Críticos</h4>
        <p>Um acerto crítico é um ataque especialmente certeiro, que atinge pontos vitais ou vulneráveis. A tabela de armas possui uma coluna “Crítico”, com margem de ameaça (18, 19 ou 20) e multiplicador (x2, x3 ou x4). Quando não aparece margem, será 20. Quando não aparece multiplicador, será x2.</p>
        ...
        <h4 className="mt-4 font-bold text-red-800">Iniciativa</h4>
        <p>A cada rodada, todo personagem tem um turno — sua vez de agir. A Iniciativa determina a ordem dos turnos dentro da rodada.</p>
        <p><strong>Teste de Iniciativa.</strong> No início do combate, cada jogador faz um teste de Iniciativa para seu personagem. O mestre faz um único teste para os inimigos. Aqueles com os resultados mais altos agem primeiro. Em caso de empate, o personagem com maior valor de perícia age primeiro; se persistir, fazem novo teste entre si. A ordem se mantém durante todo o combate.</p>
        <p><strong>Entrando na Batalha.</strong> Se um personagem entra depois que o combate começou, faz um teste de Iniciativa e age quando seu turno chegar, na rodada seguinte.</p>
        <p><strong>Surpresa.</strong> Se você não percebeu seus inimigos, está surpreendido. Se você percebeu, mas eles não, eles estão surpreendidos. Se ambos se perceberam, ninguém está surpreendido. Se nenhum lado percebe o outro, não há combate.</p>
        <p><strong>Percebendo os Inimigos.</strong> O mestre diz quem está ciente dos inimigos. Em geral, os jogadores fazem testes de Percepção contra uma dificuldade ou opostos ao teste de Furtividade dos inimigos. Um personagem que nunca fica surpreendido (como quem tem *Esquiva Sobrenatural*) pode rolar Iniciativa e agir mesmo que falhe na Percepção.</p>

        <h4 className="mt-4 font-bold text-red-800">A Rodada de Combate</h4>
        <p>Uma rodada representa cerca de seis segundos no mundo de jogo. Durante a rodada, cada jogador (incluindo o mestre) tem o seu turno. A rodada começa no turno do personagem com maior Iniciativa e termina após o turno do último. Efeitos que duram certo número de rodadas terminam imediatamente antes do mesmo resultado de Iniciativa quando se iniciaram.</p>

        <h4 className="mt-4 font-bold text-red-800">Tipos de Ações</h4>
        <p>No seu turno, você pode fazer uma <strong>ação padrão</strong> e uma <strong>ação de movimento</strong>, em qualquer ordem. Você pode trocar sua ação padrão por uma de movimento, mas não o inverso. Também pode abrir mão das duas para fazer uma <strong>ação completa</strong>. Além disso, pode executar qualquer quantidade de <strong>ações livres</strong> e <strong>reações</strong>.</p>
        <ul className="list-disc ml-6 space-y-1 mt-2">
        ...
        <h4 className="mt-4 font-bold text-red-800">Ações Padrão</h4>
        <ul className="list-disc ml-6 space-y-1 mt-2">
        ...
        <h4 className="mt-4 font-bold text-red-800">Dano Não Letal</h4>
        <p>Dano não letal conta para cair inconsciente, mas não para sangrar ou morrer. Cura recupera primeiro PV perdidos por dano não letal.</p>
        <ul className="list-disc ml-6 space-y-2 mt-2">
        ...
        <ul className="list-disc ml-6 space-y-2 mt-2">
          ...
          <li><strong>Carga.</strong> Se estiver sobrecarregado, seu deslocamento diminui em <strong>3m</strong>.</li>
          <li><strong>Diagonais.</strong> Mover-se na diagonal custa o dobro (<strong>3m por quadrado</strong>).</li>
          <li><strong>Subir ou Mergulhar.</strong> Na vertical, subir custa o dobro e descer custa a metade.</li>
          <li><strong>Terreno Difícil.</strong> Neve, raízes ou escombros. Mover-se aqui custa o dobro (<strong>3m por quadrado</strong>).</li>
        </ul>
      </>
    )
  },
      ...
      <>
        ...
        <ul className="list-disc ml-6 space-y-3 mt-4 text-amber-900/90 font-medium">
          ...
          <li>
            ...
            <ul className="list-none mt-3 space-y-3 pl-4 border-l-2 border-amber-900/30">
               <li><span className="text-red-800 font-bold">Anões, meios-elfos e qareen:</span> Envelhecem mais lentamente que humanos. Multiplique os intervalos de idade deles a partir de adulto por 2.</li>
               ...
               <li><span className="text-red-800 font-bold">Goblins e trogs:</span> São menos longevos que humanos. Multiplique todos os intervalos de idade deles por 0,7 (arredonde para o valor mais próximo).</li>
            </ul>
          </li>
        </ul>
      </>
    ...
    content: (
      <>
        ...
        <div className="space-y-4 mt-4 text-amber-900/90 font-medium">
          <div>
            <strong className="text-red-800 block mb-1">Benefícios de Objetivo</strong>
            <p className="text-sm">No início de qualquer cena diretamente relacionada a seu objetivo, você recebe um benefício de acordo com seu objetivo. Esse benefício conta como uma habilidade e dura até o fim da cena.</p>
            <p className="text-sm mt-2">Você só pode receber um benefício de objetivo por aventura. Você pode escolher não receber o benefício em uma cena se achar que a aventura terá outra cena relacionada ao objetivo, que seja mais importante. O que exatamente significa uma cena diretamente relacionada a seu objetivo fica a critério do mestre. Como regra geral, se ao término da cena você estiver mais perto de seu objetivo, a cena ativa o benefício.</p>
          </div>

          <div>
            <strong className="text-red-800 block mb-1">Penalidades de Objetivo</strong>
            <p className="text-sm">Se ao fim de uma cena você estiver mais longe de seu objetivo, sofre uma penalidade ditada por seu objetivo. Você sofre essa penalidade mesmo que seja imune a seu efeito.</p>
            <p className="text-sm mt-2">Embora a maior parte das cenas não vá aproximá-lo de seu objetivo, provavelmente também não vai afastá-lo. Assim, cenas não relacionadas ao objetivo não impõem penalidades. Por exemplo, caso seu objetivo seja casar com Vladislav Tpish, uma cena longe da Academia Arcana não o afasta de seu objetivo. Contudo, uma cena em que você briga com ele o afasta.</p>
          </div>

          <div>
            <strong className="text-red-800 block mb-1">Concluindo um Objetivo</strong>
            <p className="text-sm">Se você completar seu objetivo, recebe um benefício maior e permanente. A partir desse ponto, não recebe mais benefícios ou penalidades em cenas relacionadas ao objetivo. Você não pode escolher um novo objetivo — afinal, um objetivo heroico é algo que define toda uma vida.</p>
          </div>
        </div>
            ...
            <div key={goal.name} className="bg-[rgb(var(--bg-inset-rgb))] border-2 border-amber-900/20 rounded-xl p-5 hover:border-red-800/40 transition-colors shadow-sm">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex gap-2">
                  <span className="font-bold text-red-800 min-w-[80px]">Benefício:</span>
                  <span className="text-amber-950 font-medium">{goal.benefit}</span>
                </li>
                <li className="flex gap-2">
                  <span className="font-bold text-red-800 min-w-[80px]">Penalidade:</span>
                  <span className="text-amber-950 font-medium">{goal.penalty}</span>
                </li>
                <li className="flex gap-2">
                  <span className="font-bold text-red-800 min-w-[80px]">Conclusão:</span>
                  <span className="text-amber-950 font-medium">{goal.conclusion}</span>
                </li>
              </ul>
            </div>
          ))}
        ...
        <div className="grid grid-cols-1 gap-6 mt-8">
          {groupRoles.map((role) => (
            <div key={role.name} className="relative bg-[rgb(var(--bg-inset-rgb))] border-2 border-amber-900/20 rounded-xl p-6 hover:border-red-800/40 transition-all shadow-md group overflow-hidden">
              ...
              <p className="text-amber-900/80 text-sm font-medium leading-relaxed mb-4 border-l-2 border-amber-900/30 pl-4">
                {role.description}
              </p>
              
              <div className="mt-4 pt-4 border-t-2 border-amber-900/10 flex items-start gap-2">
                <span className="text-red-800 font-bold text-xs uppercase tracking-widest mt-0.5">Benefício:</span>
                <span className="text-amber-950 text-sm font-bold italic">{role.benefit}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="space-y-8">
              ...
              <table className="min-w-full divide-y divide-amber-900/20 font-serif">
                ...
                <tbody className="divide-y divide-amber-900/10">
                  ...
                  <tr className="bg-red-900/10 hover:bg-red-900/20 transition-colors">
                    <td className="px-6 py-4 text-amber-950 font-bold">4</td>
                    <td className="px-6 py-4 text-center text-emerald-700 font-bold">7 pontos</td>
                    <td className="px-6 py-4 text-center text-emerald-700 font-bold">18</td>
                  </tr>
                </tbody>
              </table>
            </div>

            <p className="text-amber-900/60 text-sm mt-4 italic text-center w-full font-medium">
              A tabela acima mostra a relação entre o valor do atributo, seu custo em pontos, e o resultado esperado em uma rolagem 4d6.
            </p>
          </div>
          ...
          <div className="p-6 rounded-xl bg-[rgb(var(--bg-edge-rgb))] border-2 border-amber-900/30 shadow-sm w-full mt-8">
            ...
            <p className="text-amber-900/90 font-medium leading-relaxed">
              Independentemente do método escolhido, lembre-se de que seus atributos podem ser aumentados conforme você sobe de nível. Escolha valores que façam sentido para o conceito do seu personagem, não apenas os números mais altos!
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-10 pb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 rounded-xl bg-red-900/5 border-2 border-red-800/20 text-red-900 font-bold text-sm shadow-sm">
              Enquanto tiver pelo menos 1 ponto de vida, você pode agir e lutar normalmente. Se ficar com 0 ou menos PV, você cai inconsciente e sangrando.
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 rounded-xl bg-blue-900/5 border-2 border-blue-800/20 text-blue-900 font-bold text-sm italic shadow-sm">
              Você não pode gastar mais pontos de mana do que tem, mas não sofre penalidades por ficar com 0 ou menos PM.
            </div>
          </div>
        </div>

        {/* Recuperação e Secundários */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
           ...
           <div className="space-y-4">
             ...
             <p className="text-sm italic text-amber-900/70 font-medium border-l-4 border-amber-900/30 pl-3 mt-4">
               Exemplo: Helior, elfo caçador de 7º nível, recupera 7 PV e 7 PM numa estalagem. Dormindo ao relento, recupera apenas 3 PV e 3 PM.
             </p>
           </div>
           ...
           <div className="space-y-8">
             <div className="space-y-2">
               ...
               <p className="text-amber-950 font-medium leading-relaxed">
                 Certos efeitos fornecem PV ou PM temporários. Eles são somados a seus pontos atuais, mesmo que ultrapassem o máximo. Pontos temporários são <strong>sempre os primeiros a serem gastos</strong> e desaparecem no fim do dia.
               </p>
             </div>
             ...
             <div className="space-y-2">
               ...
               <p className="text-amber-950 font-medium leading-relaxed">
                 Sua velocidade, medida em quantos metros você anda com uma ação de movimento. Por padrão, <strong>seu deslocamento é 9 metros (6 quadrados no mapa)</strong>, mas algumas habilidades ou excesso de carga podem mudar esse valor.
               </p>
             </div>
        ...
        <div className="space-y-4 pt-4 border-t-2 border-dashed border-amber-900/20">
          ...
          <div className="p-5 bg-[rgb(var(--bg-inset-rgb))] border-2 border-amber-900/20 rounded-xl text-sm leading-relaxed text-amber-900/90 font-medium flex flex-col md:flex-row gap-6 shadow-sm">
            ...
            <div className="flex-1">
              <strong className="text-red-800 block mb-2 text-base">Armas de outros tamanhos:</strong>
              Usar uma arma feita para uma categoria diferente da sua impõe penalidade de –5 no teste de ataque.
            </div>
          </div>
          <CreatureSizeTable data={creatureSizeTable} footnote={creatureSizeTableFootnote} />
        </div>
