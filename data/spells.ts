...
export const spells: Spell[] = [
  ...
  { id: "Globo da Verdade de Gwen",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+1 PM", effect: "O globo mostra uma cena vista até um mês atrás." },
      { cost: "+2 PM", effect: "Como acima, até um ano atrás." },
      { cost: "+2 PM", effect: "Ao lançar a magia, você pode tocar um cadáver. O globo mostra a última cena vista por essa criatura." },
      { cost: "+4 PM", effect: "Muda o alcance para longo e o efeito para 10 globos. Todos mostram a mesma cena." },
    ],
  },
  { id: "Globo de Invulnerabilidade",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+4 PM", effect: "Muda o efeito para afetar magias de até 3º círculo. Requer 4º círculo." },
      { cost: "+9 PM", effect: "Muda o efeito para afetar magias de até 4º círculo. Requer 5º círculo." },
    ],
  },
  { id: "Guardião Divino",
  ...
  { id: "Heroísmo",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+2 PM", effect: "Muda o bônus para +6." },
    ],
  },
  { id: "Hipnotismo",
    name: "Hipnotismo",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "Truque", effect: "Muda a duração para 1 rodada. Em vez de fascinado, o alvo fica pasmo (apenas uma vez por cena)." },
      { cost: "+1 PM", effect: "Como o normal, mas alvos que passem na resistência não sabem que foram vítimas de uma magia." },
      { cost: "+2 PM", effect: "Muda o alvo para animais ou humanoides escolhidos." },
      { cost: "+2 PM", effect: "Muda a duração para sustentada." },
      { cost: "+2 PM", effect: "Também afeta espíritos e monstros na área. Requer 2º círculo." },
      { cost: "+5 PM", effect: "Também afeta construtos, espíritos, monstros e mortos-vivos na área. Requer 3º círculo." },
    ],
  },
  { id: "Ilusão Lacerante",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+3 PM", effect: "Aumenta o dano em +2d6." },
      { cost: "+4 PM", effect: "Muda a área para um cubo de 90m. Requer 4º círculo." },
    ],
  },
  { id: "Imagem Espelhada",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+2 PM", effect: "Aumenta o número de cópias em +1 (e o bônus na Defesa em +2)." },
      { cost: "+2 PM", effect: "Além do normal, toda vez que uma cópia é destruída, emite um clarão de luz. A criatura que destruiu a cópia fica ofuscada por uma rodada. Requer 2º círculo." },
    ],
  },
  { id: "Imobilizar",
    name: "Imobilizar",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+1 PM", effect: "Muda o alvo para 1 espírito." },
      { cost: "+2 PM", effect: "Aumenta o número de alvos em +1." },
      { cost: "+3 PM", effect: "Muda o alvo para 1 criatura. Requer 4º círculo." },
    ],
  },
  { id: "Infligir Ferimentos",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+1 PM", effect: "Além do normal, se falhar na resistência, o alvo fica fraco pela cena." },
      { cost: "+2 PM", effect: "Aumenta o dano em +1d8+1." },
      { cost: "+2 PM", effect: "Muda a resistência para nenhum. Como parte da execução da magia, você pode fazer um ataque corpo a corpo contra o alvo. Se acertar, causa o dano do ataque e o efeito da magia." },
      { cost: "+5 PM", effect: "Muda o alcance para curto e o alvo para criaturas escolhidas." },
    ],
  },
  { id: "Intervenção Divina",
  ...
  { id: "Invisibilidade",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+1 PM", effect: "Muda a execução para ação padrão, o alcance para toque e o alvo para 1 criatura ou 1 objeto Grande ou menor." },
      { cost: "+3 PM", effect: "Muda a duração para cena. Requer 3º círculo." },
      { cost: "+3 PM", effect: "Muda a duração para sustentada. Em vez do normal, o alvo gera uma esfera de invisibilidade. Não pode ser usado em conjunto com outros aprimoramentos. O alvo e todas as criaturas a até 3m dele se tornam invisíveis, como no efeito normal da magia (ainda ficam visíveis caso façam uma ação hostil). A esfera se move juntamente com o alvo; qualquer coisa que saia da esfera fica visível. Requer 3º círculo." },
      { cost: "+7 PM", effect: "Muda a execução para ação padrão, o alcance para toque e o alvo para 1 criatura. A magia não é dissipada caso o alvo faça uma ação hostil. Requer 4º círculo." },
    ],
  },
  ...
  { id: "Legião",
    ...
    duration: "Sustentada",
    resistance: "Vontade parcial",
    description: "Você domina a mente dos alvos. Os alvos obedecem cegamente a seus comandos, exceto ordens claramente suicidas. Um alvo tem direito a um teste no final de cada um de seus turnos para se livrar do efeito. Alvos que passarem no teste ficam abalados por 1 rodada enquanto recuperam a consciência.",
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+1 PM", effect: "Aumenta o número de alvos em +1." },
    ],
  ...
  { id: "Lendas e Histórias",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+4 PM", effect: "Muda a execução para um dia, o alcance para ilimitado e adiciona componente material (cuba de ouro cheia d’água e ingredientes mágicos, no valor de T$ 1.000). Você ainda precisa ter alguma informação sobre o alvo, como um nome, descrição ou localização." },
    ],
  },
  { id: "Leque Cromático",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+2 PM", effect: "Além do normal, as criaturas afetadas ficam vulneráveis pela cena." },
      { cost: "+2 PM", effect: "Também afeta espíritos e monstros na área. Requer 2º círculo." },
      { cost: "+5 PM", effect: "Também afeta construtos, espíritos, monstros e mortos-vivos na área. Requer 3º círculo." },
    ],
  },
  { id: "Libertação",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+2 PM", effect: "Além do normal, o alvo pode caminhar sobre a água ou outros líquidos com seu deslocamento normal. Entretanto, isso não protege contra qualquer efeito que o líquido possa causar (o alvo pode andar sobre lava, mas ainda vai sofrer dano)." },
      { cost: "+2 PM", effect: "Além do normal, o alvo pode escolher 20 em todos os testes de Atletismo." },
      { cost: "+2 PM", effect: "Além do normal, o alvo pode escolher 20 em todos os testes de Acrobacia e pode fazer todas as manobras desta perícia mesmo sem treinamento." },
      { cost: "+5 PM", effect: "Muda o alcance para curto e o alvo para até 5 criaturas." },
      { cost: "+5 PM", effect: "Pode dissipar Aprisionamento." },
    ],
  },
  { id: "Ligação Sombria",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+5 PM", effect: "A magia não termina se o alvo chegar a 0 PV (o que significa que dano causado por essa magia pode matá-lo)." },
    ],
  },
  { id: "Ligação Telepática",
    ...
    duration: "1 dia",
    resistance: "Nenhuma",
    description: "ocê cria um elo mental entre duas criaturas com Inteligência –4 ou maior (você pode ser uma delas). As criaturas podem se comunicar independente de idioma ou distância, mas não em mundos diferentes.",
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+2 PM", effect: "Aumenta o número de alvos em +1." },
      { cost: "+3 PM", effect: "Muda o alvo para 1 criatura. Em vez do normal, você cria um elo mental que permite que você veja e ouça pelos sentidos da criatura, se gastar uma ação de movimento. Uma criatura involuntária pode fazer um teste de Vontade para suprimir a magia por uma hora. Requer 3º círculo." },
    ],
  },
  { id: "Localização",
    name: "Localização",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "Truque", effect: "Muda a área para alvo você. Em vez do normal, você sabe onde fica o norte e recebe +5 em testes de Sobrevivência para se orientar." },
      { cost: "+5 PM", effect: "Aumenta a área em um fator de 10 (90m para 900m, 900m para 9km e assim por diante)." },
    ],
  },
  { id: "Luz",
    name: "Luz",
    ...
    target: "1 objeto",
    duration: "Cena",
    resistance: "Vontade aula (Veja texto)",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+1 PM", effect: "Aumenta a área iluminada em +3m de raio." },
      { cost: "+2 PM", effect: "Muda a duração para um dia." },
      { cost: "+2 PM", effect: "Muda a duração para permanente e adiciona componente material (pó de rubi no valor de T$ 50). Não pode ser usado em conjunto com outros aprimoramentos. Requer 2º círculo." },
      { cost: "+0 PM (Apenas Arcanos)", effect: "Muda o alvo para 1 criatura. Você lança a magia nos olhos do alvo, que fica ofuscado pela cena. Não afeta criaturas cegas." },
      ...
      { cost: "+2 PM (Apenas Divinos)", effect: "A luz é cálida como a do sol. Criaturas que sofrem penalidades e dano pela luz solar sofrem seus efeitos como se estivessem expostos à luz solar real. Seus aliados na área estabilizam automaticamente e ficam imunes à condição sangrando, e seus inimigos ficam ofuscados. Requer 2º círculo." },
      { cost: "+5 PM (Apenas Divinos)", effect: "Muda o alcance para toque e o alvo para 1 criatura. Em vez do normal, o alvo é envolto por um halo de luz, recebendo +10 em testes de Diplomacia e redução de trevas 10. Requer 2º círculo." },
    ],
  },
  { id: "Manto de Sombras",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+4 PM", effect: "Muda o alcance para toque e o alvo para 1 criatura. Requer 4º círculo." },
    ],
  },
  { id: "Manto do Cruzado",
  ...
  { id: "Mapear",
    ...
    execution: "Padrão",
    range: "Toque",
    target: "Superfície ou objeto plano, como mesa ou papel",
    duration: "Cena",
    resistance: "Nenhuma",
  ...
  { id: "Marca da Obediência",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+3 PM", effect: "Muda a duração para um dia. Se não estiver em combate, a criatura só pode fazer o teste de Vontade a cada hora. Requer 3º círculo." },
      { cost: "+3 PM", effect: "Sempre que o alvo fizer o teste de Vontade e falhar, a marca causa 3d6 pontos de dano psíquico. Requer 3º círculo." },
    ],
  },
  { id: "Marionete",
    name: "Marionete",
  ...
  { id: "Mata-Dragão",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+1 PM", effect: "Aumenta o dano em +1d12." },
    ],
  },
  { id: "Mente Divina",
    name: "Mente Divina",
    ...
    enhancements: [
      { cost: "+3 PM", effect: "Muda o alcance para curto e o alvo para criaturas escolhidas." },
      { cost: "+3 PM", effect: "Em vez do normal, o alvo recebe +2 nos três atributos mentais. Requer 3º círculo." },
      { cost: "+7 PM", effect: "Em vez do normal, o alvo recebe +4 no atributo escolhido. Requer 4º círculo." },
      { cost: "+12 PM", effect: "Em vez do normal, o alvo recebe +4 nos três atributos mentais. Requer 5º círculo." },
    ],
  },
  { id: "Metamorfose",
    name: "Metamorfose",
  ...
  { id: "Miasma Mefítico",
    ...
    description: "A área é coberta por emanações letais. Criaturas na área sofrem 5d6 pontos de dano de ácido e ficam enjoadas por 1 rodada. Se passarem na resistência, sofrem metade do dano e não ficam enjoadas.",
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      ...
      { cost: "+2 PM", effect: "Aumenta o dano em +1d6." },
      { cost: "+3 PM", effect: "Muda o tipo do dano para trevas." },
    ],
  },
  { id: "Miragem",
    name: "Miragem",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+4 PM", effect: "Além do normal, pode alterar a aparência de criaturas escolhidas na área, como se usando Disfarce Ilusório." },
      { cost: "+9 PM", effect: "Muda a duração para permanente e adiciona componente material (pó de diamante no valor de T$ 1.000). Requer 4º círculo." },
    ],
  },
  { id: "Missão Divina",
    name: "Missão Divina",
    ...
    enhancements: [
      ...
      { cost: "+4 PM", effect: "Muda a duração para 1 ano ou até ser descarregada." },
    ],
  },
  { id: "Montaria Arcana",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+1 PM", effect: "Além do normal, criaturas do tipo animal em alcance curto da montaria devem fazer um teste de Vontade. Se passarem, ficam abaladas pela cena; se falharem, ficam apavoradas por 1d4 rodadas, depois abaladas pela cena." },
      { cost: "+3 PM", effect: "Muda a duração para permanente e adiciona penalidade de –3 PM." },
      { cost: "+3 PM", effect: "Aumenta o tamanho da montaria em uma categoria. Isso também aumenta o número de criaturas que ela pode carregar — duas para uma criatura Enorme, seis para Colossal. Uma única criatura controla a montaria; as outras apenas são deslocadas." },
      { cost: "+3 PM", effect: "Muda o nível do parceiro para mestre. Requer 3º círculo." },
    ],
  },
  { id: "Muralha de Ossos",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+3 PM", effect: "Aumenta o comprimento em +15m e a altura em +3m." },
      { cost: "+5 PM", effect: "O muro é feito de uma massa de esqueletos animados. Sempre que uma criatura iniciar seu turno adjacente ou escalando a muralha, deve fazer um teste de Reflexos. Se falhar fica agarrada, sofrendo os efeitos normais de estar agarrada pela magia." },
    ],
  },
  ...
  { id: "Névoa",
    ...
    duration: "Cena",
    resistance: "Nenhuma",
    description: "Uma névoa espessa eleva-se de um ponto a sua escolha, obscurecendo toda a visão — criaturas a até 1,5m têm camuflagem leve e criaturas a partir de 3m têm camuflagem total. Um vento forte dispersa a névoa em 4 rodadas e um vendaval a dispersa em 1 rodada. Esta magia não funciona sob a água.",
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+1 PM", effect: "A magia também funciona sob a água, criando uma nuvem de tinta." },
      { cost: "+2 PM", effect: "Você pode escolher criaturas no alcance ao lançar a magia; elas enxergam através do efeito. Requer 2º círculo." },
      { cost: "+2 PM", effect: "A nuvem tem um cheiro horrível. No início de seus turnos, qualquer criatura dentro dela, ou qualquer criatura com faro em alcance curto da nuvem, deve fazer um teste de Fortitude. Se falhar, fica enjoada por uma rodada." },
      { cost: "+2 PM", effect: "A nuvem tem um tom esverdeado e se torna cáustica. No início de seus turnos, criaturas dentro dela sofrem 2d4 pontos de dano de ácido." },
      { cost: "+3 PM", effect: "Aumenta o dano de ácido em +2d4." },
      { cost: "+5 PM", effect: "Além do normal, a nuvem fica espessa, quase sólida. Qualquer criatura dentro dela tem seu deslocamento reduzido para 3m (independentemente de seu deslocamento normal) e sofre –2 em testes de ataque e rolagens de dano." },
    ],
  },
  { id: "Oração",
    name: "Oração",
    ...
    enhancements: [
      { cost: "+2 PM", effect: "Aumenta os bônus em +1 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar)." },
      { cost: "+2 PM", effect: "Aumenta as penalidades em –1 (penalidade máxima limitada pelo círculo máximo de magia que você pode lançar)." },
      { cost: "+7 PM", effect: "Muda o alcance para médio. Requer 3º círculo." },
      { cost: "+12 PM", effect: "Muda a duração para cena. Requer 4º círculo." },
    ],
  },
  { id: "Orientação",
    name: "Orientação",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+2 PM", effect: "Muda a duração para cena. Em vez do normal, escolha um atributo. Sempre que o alvo fizer um teste de perícia baseado no atributo escolhido, pode rolar dois dados e ficar com o melhor resultado. Não se aplica a testes de ataque ou resistência. Requer 2º círculo." },
      { cost: "+5 PM", effect: "Como acima, mas, em vez de um atributo, escolha entre atributos físicos (Força, Destreza e Constituição) ou mentais (Inteligência, Sabedoria e Carisma). Requer 3º círculo." },
      { cost: "+5 PM", effect: "Muda o alvo para criaturas escolhidas. Requer 3º círculo." },
    ],
  },
  ...
  { id: "Poeira da Podridão",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+2 PM", effect: "Aumenta o dano em +1d8+4." },
    ],
  },
  { id: "Possessão",
    name: "Possessão",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+5 PM", effect: "Você ganha acesso às habilidades de raça e classe da criatura." },
      { cost: "+5 PM", effect: "Enquanto a magia durar e você estiver dentro do alcance do seu corpo original, pode “saltar” de uma criatura possuída para outra. O novo alvo tem direito a um teste de Vontade. Se falhar, você assume o controle do corpo dele e o alvo anterior recobra a consciência." },
      { cost: "+5 PM", effect: "Muda a duração para permanente, mas destrói seu corpo original no processo. Uma criatura possuída pode fazer um teste de Vontade no começo do dia para retomar seu corpo. Se passar, recobra a consciência (e a sua própria consciência fica inerte). O teste se repete no início de cada dia. Se o corpo de uma criatura possuída morrer e houver outra criatura em alcance curto, você pode tentar possuí-la. Enquanto houver novos corpos para possuir, você é imortal!" },
    ],
  },
  { id: "Potência Divina",
    ...
    origin: "Tormenta20 - Jogo do Ano",
    enhancements: [
      { cost: "+2 PM", effect: "Aumenta o bônus de Força em +1." },
      { cost: "+5 PM", effect: "Aumenta a RD em +5." },
      { cost: "+2 PM", effect: "Muda o alcance para toque e o alvo para 1 criatura. A magia falha se você e o alvo não forem devotos da mesma divindade." },
    ],
  },
  {id: "Premonição",
  name: "Premonição",
  ...
  enhancements: [
    {
      cost: "+1 PM",
      effect: "Além do normal, o alvo recebe um bônus adicional de +20 em testes de Atletismo para saltar (para um bônus total de +30).",
    },
    {
      cost: "+1 PM",
      effect: "Além do normal, o alvo pode escalar paredes e tetos sem precisar fazer testes de Atletismo. Para isso, precisa estar com as mãos livres, mas pode usar uma única mão se ficar parado no lugar. O alvo não fica desprevenido enquanto escala.",
    },
    {
      cost: "+1 PM",
    ...
    {
      cost: "+3 PM",
      effect: "Além do normal, ao fazer testes de perícias baseadas em Força, Destreza ou Constituição, o alvo pode rolar dois dados e escolher o melhor. Não afeta testes de ataque ou resistência. Requer 2º círculo.",
    },
  ],
  },
  { id: "Profanar",
  ...
  duration: "1 dia",
  resistance: "Nenhuma",
  description: "Você enche a área com energia negativa. Dano de trevas é maximizado dentro da área. Isso também afeta PV curados em mortos-vivos por esses efeitos. Esta magia não pode ser lançada em uma área contendo um símbolo visível dedicado a uma divindade que não a sua. Profanar anula Consagrar.",
  origin: "Tormenta20 - Jogo do Ano",
  enhancements: [
    {
      cost: "+1 PM",
      effect: "Além do normal, mortos-vivos na área recebem +2 na Defesa e +2 em todos os testes.",
    },
    {
      cost: "+2 PM",
      effect: "Aumenta os bônus para mortos-vivos em +1 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar).",
    },
    {
      cost: "+9 PM",
      effect: "Muda a execução para 1 hora, a duração para permanente e adiciona componente material (incenso e óleos no valor de T$ 1.000). Requer 4º círculo.",
    },
  ],
  },
  { id: "Projetar Consciência",
  ...
  enhancements: [
    {
      cost: "+4 PM",
      effect: "Muda o bônus para +10. Requer 4º círculo.",
    },
    {
      cost: "+4 PM",
      effect: "Em vez do normal, o alvo fica imune a uma escola de magia a sua escolha. Requer 4º Círculo.",
    },
    {
      cost: "+9 PM",
      effect: "Em vez do normal, o alvo fica imune a duas escolas de magia a sua escolha. Requer 5º Círculo.",
    },
  ],
  },
  { id: "Proteção Divina",
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Aumenta o bônus concedido em +1.",
    },
    {
      cost: "+2 PM",
      effect: "Muda a execução para reação, o alcance para curto e a duração para 1 rodada. Em vez do normal, o alvo recebe +5 no próximo teste de resistência que fizer (cumulativo com o efeito básico desta magia).",
    },
    {
      cost: "+2 PM",
      effect: "Muda o alvo para área de esfera com 3m de raio. Todos os aliados dentro do círculo recebem o bônus da magia. Requer 2º círculo.",
    },
    {
      cost: "+5 PM",
      effect: "Torna o alvo imune a efeitos mentais e de medo. Requer 3º círculo.",
    },
  ],
  },
  { id: "Purificação",
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Também recupera todos os PV perdidos por veneno.",
    },
    {
      cost: "+2 PM",
      effect: "Em vez de uma, remove todas as condições listadas.",
    },
    {
      cost: "+3 PM",
      effect: "Também permite que o alvo solte qualquer item amaldiçoado que esteja segurando (mas não remove a maldição do item em si).",
    },
    {
      cost: "+7 PM",
      effect: "Também dissipa magias e efeitos prejudiciais de encantamento, necromancia e transmutação afetando o alvo. Requer 3º círculo.",
    },
  ],
  },
  { id: "Queda Suave",
  ...
  enhancements: [
    {
      cost: "Truque",
      effect: "Muda o alvo para objeto Minúsculo. Em vez do normal, você pode gastar uma ação de movimento para levitar o alvo até 4,5m em qualquer direção.",
    },
    {
      cost: "+2 PM",
      effect: "Muda o alvo para até 10 criaturas ou objetos adequados.",
    },
    {
      cost: "+2 PM",
  ...
  duration: "Cena",
  resistance: "Fortitude parcial",
  description: "Você dispara um raio púrpura que drena as forças do alvo. Se falhar na resistência, o alvo fica fatigado. Se passar, fica vulnerável. Note que, como efeitos de magia não acumulam, lançar esta magia duas vezes contra o mesmo alvo não irá deixá-lo exausto.",
  origin: "Tormenta20 - Jogo do Ano",
  enhancements: [
    {
      cost: "Truque",
      effect: "Muda o alcance para toque e a resistência para Fortitude anula. Em vez do normal, sua mão emana um brilho púrpura e, ao tocar o alvo, ele fica fatigado.",
    },
    {
      cost: "+2 PM",
      effect: "Em vez do normal, se falhar na resistência o alvo fica exausto. Se passar, fica fatigado. Requer 2º círculo.",
    },
    {
      cost: "+5 PM",
      effect: "Como acima, mas muda o alvo para criaturas escolhidas. Requer 3º círculo.",
    },
  ],
  },
  { id: "Raio Polar",
  ...
  enhancements: [
    {
      cost: "Truque",
      effect: "Muda a duração para cena e a resistência para nenhuma. Em vez do normal, cria um facho de luz que ilumina a área da magia. Uma vez por rodada, você pode mudar a direção do facho como uma ação livre.",
    },
    {
      cost: "+2 PM",
      effect: "Aumenta o dano ou cura em +1d8 (ou +1d12 em mortos-vivos).",
    },
    {
      cost: "+3 PM",
      effect: "Em vez do normal, criaturas vivas a sua escolha na área curam 4d8 pontos de vida; o restante sofre o dano normalmente.",
    },
    {
      cost: "+3 PM",
      effect: "Criaturas que falhem na resistência ficam cegas por 1d4 rodadas.",
    },
  ],
  },
  { id: "Reanimação Impura",
  ...
  enhancements: [
    {
      cost: "+1 PM",
      effect: "Além do normal, os limites do domo são envoltos por uma fumaça escura e espessa, que impede criaturas do lado de fora de enxergar ou ouvir o que está dentro. Criaturas do lado de dentro enxergam e ouvem normalmente o que está do lado de fora. A fumaça também bloqueia magias de adivinhação.",
    },
    {
      cost: "+3 PM",
  ...
  execution: "Duas rodadas",
  range: "Médio",
  target: "Bolas de fogo e relâmpagos", 
  duration: "Sustentada",
  resistance: "Reflexos reduz à metade",
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Aumenta a redução de dano em +5.",
    },
    {
      cost: "+2 PM",
      effect: "Muda a duração para um dia. Requer 2º círculo.",
    },
    {
      cost: "+5 PM",
      effect: "Muda o alcance para curto e o alvo para criaturas escolhidas. Requer 3º círculo.",
    },
    {
      cost: "+5 PM",
      effect: "Muda o efeito para redução de dano contra todos os tipos listados na magia. Requer 3º círculo.",
    },
    {
      cost: "+9 PM",
      effect: "Muda o efeito para imunidade a um tipo listado na magia. Requer 4º círculo.",
    },
  ],
  },
  { id: "Rogar Maldição",
  ...
  enhancements: [
    {
      cost: "+3 PM",
      effect: "Aumenta o número de efeitos que você pode escolher em +1. Requer 3º círculo.",
    },
    {
      cost: "+7 PM",
      effect: "Muda a duração para permanente e resistência para Fortitude parcial. Se passar, a criatura ainda sofre os efeitos da maldição, mas por 1 rodada. Requer 4º círculo.",
    },
  ],
  },
  { id: "Roubar a Alma",
  ...
  enhancements: [
    {
      cost: "+5 PM",
      effect: "O objeto que abriga a alma detém os mesmos PM totais que o alvo. Se estiver empunhando o objeto, você pode usar esses PM para lançar magias no lugar dos seus. O objeto recupera PM por dia como se o personagem estivesse em descanso normal.",
    },
    {
      cost: "+10 PM",
      effect: "Como uma reação ao lançar esta magia, você possui o corpo sem alma do alvo, como na magia Possessão (mesmo que não conheça a magia).",
    },
  ],
  },
  { id: "Runa de Proteção",
  ...
  enhancements: [
    ...
    {
      cost: "+3 PM",
      effect: "Como o aprimoramento anterior, mas você pode escolher magias de 2º círculo. Requer 3º círculo.",
    },
  ],
  },
  ...
  enhancements: [
    {
      cost: "+1 PM",
      effect: "Muda o alcance para médio.",
    },
    {
      cost: "+1 PM",
      effect: "Muda o alvo para você e uma criatura voluntária. Você pode escolher este aprimoramento mais vezes para aumentar o número de alvos adicionais em +1, mas deve estar tocando todos os alvos.",
    },
    {
      cost: "+2 PM",
      effect: "Muda a execução para reação. Em vez do normal, você recebe +5 na Defesa e em testes de Reflexos contra um ataque ou efeito que esteja prestes a atingi-lo. Após a resolução do efeito, salta para um espaço adjacente (1,5m).",
    },
    {
      cost: "+3 PM",
      effect: "Muda o alcance para longo.",
    },
  ],
  },
  { id: "Santuário",
  ...
  enhancements: [
    {
      cost: "+1 PM",
      effect: "Além do normal, escolha um tipo de criatura entre animal, construto ou morto-vivo. Você não pode ser percebido por criaturas não inteligentes (Int –4 ou menor) do tipo escolhido.",
    },
    {
      cost: "+9 PM",
      effect: "Também protege o alvo contra efeitos de área. Uma criatura que tente atacar uma área que inclua o alvo deve fazer o teste de Vontade; se falhar, não consegue e perde a ação. Ela só pode tentar novamente se o alvo sair da área.",
    },
  ],
  },
  { id: "Segunda Chance",
  ...
  enhancements: [
    {
      cost: "+1 PM",
      effect: "Aumenta a cura em +20 PV.",
    },
    {
      cost: "+2 PM",
      effect: "Muda o alcance para curto e o alvo para até 5 criaturas.",
    },
    {
      cost: "+5 PM",
      effect: "Muda o alvo para uma criatura que tenha morrido há até uma rodada. Esta magia pode curá-la.",
    },
  ],
  },
  { id: "Selo de Mana",
  ...
  enhancements: [
    {
      cost: "+4 PM",
      effect: "Muda o alcance para curto e o alvo para criaturas escolhidas dentro do alcance. Requer 4º círculo.",
    },
  ],
  },
  { id: "Semiplano",
  ...
  execution: "Completa",
  range: "Curto",
  target: "Semiplano com 30m de lado",
  duration: "1 dia",
  resistance: "Nenhuma",
  ...
  enhancements: [
    ...
    {
      cost: "+5 PM",
      effect: "Muda a duração para permanente e adiciona componente material (maquete do semiplano feita de materiais preciosos no valor de T$ 5.000). Você pode lançar a magia diversas vezes para aumentar as dimensões do semiplano em +30m de lado a cada vez.",
    },
  ],
  },
  { id: "Servo Divino",
  ...
  enhancements: [
    {
      cost: "+4 PM",
      effect: "Muda a duração para um dia ou até ser descarregada. O espírito realiza uma tarefa a sua escolha que exija até um dia. O custo do pagamento aumenta para T$ 500. O resto segue normal.",
    },
    {
      cost: "+9 PM",
      effect: "Muda a duração para 1 semana ou até ser descarregada. O espírito realiza uma tarefa que exija até uma semana. O custo do pagamento aumenta para T$ 1.000. O resto segue normal.",
    },
  ],
  },
  { id: "Servo Morto-Vivo",
  ...
  enhancements: [
    {
      cost: "+3 PM",
      effect: "Muda o componente material para pó de ônix negro (T$ 500). Em vez de um zumbi ou esqueleto, cria um carniçal. Ele pode funcionar como um parceiro veterano, escolhido entre ajudante, atirador, combatente, fortão ou guardião. O resto segue normal.",
    },
    {
      cost: "+3 PM",
      effect: "Muda o componente material para pó de ônix negro (T$ 500). Em vez de um zumbi ou esqueleto, cria uma sombra. Ela pode funcionar como um parceiro veterano, escolhido entre assassino, combatente ou perseguidor. O restante da magia segue normal.",
    },
    {
      cost: "+7 PM",
      effect: "Muda o componente material para ferramentas de embalsamar (T$ 1.000). Em vez de um zumbi ou esqueleto, cria uma múmia. Ela pode funcionar como um parceiro mestre, escolhido entre ajudante, destruidor, guardião ou médico. O restante da magia segue normal. Requer 4º círculo.",
    },
  ],
  },
  { id: "Servos Invisíveis",
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Muda as setas para lanças de energia que surgem e caem do céu. Cada lança causa 1d8+1 pontos de dano de essência. Requer 2º círculo.",
    },
    {
      cost: "+2 PM",
      effect: "Muda o número de setas/lanças para três.",
    },
    {
      cost: "+4 PM",
      effect: "Muda o número de setas/lanças para cinco. Requer 2º círculo.",
    },
    {
      cost: "+9 PM",
      effect: "Muda o número de setas/lanças para dez. Requer 4º círculo.",
    },
  ],
  },
  { id: "Silêncio",
  ...
  enhancements: [
    {
      cost: "+1 PM",
      effect: "Muda a área para alvo de 1 objeto. Em vez do normal, o alvo emana uma área de silêncio com 3m de raio. Se lançar a magia num objeto de uma criatura involuntária, ela tem direito a um teste de Vontade para anulá-la.",
    },
    {
      cost: "+2 PM",
      effect: "Muda a duração para cena. Em vez do normal, nenhum som pode deixar a área, mas criaturas dentro da área podem falar, ouvir e lançar magias com palavras mágicas normalmente.",
    },
  ],
  },
  { id: "Soco de Arsenal",
  ...
  enhancements: [
    {
      cost: "+1 PM",
      effect: "Muda o alcance para pessoal, o alvo para você, a duração para cena do normal, seus ataques corpo a corpo passam a acertar inimigos distantes. Seu alcance natural aumenta em 3m; uma criatura Média pode atacar adversários a até 4,5m, por exemplo.",
    },
    {
      cost: "+2 PM",
    ...
    {
      cost: "+4 PM",
      effect: "Aumenta o empurrão em +3m.",
    },
    {
      cost: "+5 PM",
      effect: "Muda o tipo do dano para essência.",
    },
  ],
  },
  { id: "Sombra Assassina",
  ...
  enhancements: [
    {
      cost: "+10 PM",
      effect: "Muda o alvo para criaturas escolhidas na área.",
    },
  ],
  },
  { id: "Sonho",
  ...
  enhancements: [
    ...
    {
      cost: "+1 PM",
      effect: "Aumenta o número de alvos em +1. Todos os alvos compartilham um mesmo sonho (ou pesadelo) entre si e com você.",
    },
  ],
  },
  { id: "Sono",
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Alvos que falhem na resistência ficam exaustos por 1d4+1 rodadas, em vez de apenas 1.",
    },
    {
      cost: "+2 PM",
      effect: "Muda o alvo para criatura.",
    },
    {
      cost: "+5 PM",
      effect: "Afeta todos os alvos válidos a sua escolha dentro do alcance.",
    },
  ],
  },
  { id: "Sopro da Salvação",
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Aumenta a cura em +1d8+2.",
    },
    {
      cost: "+4 PM",
      effect: "Além do normal, se um aliado estiver com PV negativos, seus PV são levados a 0 e então a cura é aplicada.",
    },
    {
      cost: "+4 PM",
      effect: "Remove todas as condições listadas, em vez de apenas uma.",
    },
  ],
  },
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Aumenta o dano de frio em +2d6.",
    },
    {
      cost: "+3 PM",
  ...
  enhancements: [
    {
      cost: "+5 PM",
      effect: "Muda o alcance para curto e o alvo para criaturas escolhidas.",
    },
  ],
  },
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Aumenta o número de alvos em +1.",
    },
    {
      cost: "+3 PM",
      effect: "Muda o alvo para 1 criatura.",
    },
    {
      cost: "+12 PM",
      effect: "Muda o alvo para criaturas escolhidas. Requer 5º círculo.",
    },
  ],
  },
  { id: "Talho Invisível de Edauros",
  ...
  enhancements: [
    ...
    {
      cost: "+2 PM",
      effect: "Muda o alvo para você, a duração para sustentada e o efeito para uma vez por rodada, como uma ação de movimento, você pode disparar uma lâmina de ar contra um alvo em alcance médio, causando 6d8 pontos de dano de corte (Fortitude reduz à metade).",
    },
  ],
  },
  { id: "Teia",
  ...
  duration: "Cena",
  resistance: "Reflexos anula",
  description: "Teia cria várias camadas de fibras entrelaçadas e pegajosas na área. Qualquer criatura na área que falhar na resistência fica enredada. Uma vítima pode se libertar com uma ação padrão e um teste de Acrobacia ou Atletismo. A área ocupada por Teia é terreno difícil. \nA Teia é inflamável. Qualquer ataque que cause dano de fogo destrói as teias por onde passar, libertando as criaturas enredadas mas deixando-as em chamas.",
  origin: "Tormenta20 - Jogo do Ano",
  enhancements: [
    {
      cost: "+1 PM",
      effect: "Além do normal, criaturas que falhem na resistência também ficam imóveis.",
    },
    {
      cost: "+2 PM",
      effect: "Além do normal, no início de seus turnos a magia afeta novamente qualquer criatura na área, exigindo um novo teste de Reflexos. Requer 2º círculo.",
    },
    {
      cost: "+2 PM",
      effect: "Aumenta a área em +1 cubo de 1,5m.",
    },
  ],
  },
  { id: "Telecinesia",
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Aumenta o número de alvos em +5.",
    },
    {
      cost: "+2 PM",
  ...
  execution: "Completa",
  range: "Longo",
  target: "Cilindro com 15m de raio e 15m de altura",
  duration: "Sustentada",
  resistance: "Nenhuma",
  ...
  enhancements: [
    {
      cost: "+1 PM",
      effect: "Além do normal, uma vez por rodada você pode gastar uma ação padrão para fazer um raio cair sobre um alvo na área, causando 3d8 pontos de dano de eletricidade (Reflexos reduz à metade).",
    },
    {
      cost: "+2 PM",
      effect: "Aumenta o dano de raios (veja acima) em +1d8.",
    },
    {
      cost: "+3 PM",
    ...
    {
      cost: "+3 PM",
      effect: "Se escolheu causar granizo, muda o dano para 2d6 por rodada.",
    },
    {
      cost: "+3 PM",
      effect: "Se escolheu causar neve, criaturas na área sofrem 2d6 pontos de dano de frio no início de seus turnos.",
    },
    {
      cost: "+3 PM",
  ...
  target: "Esfera com 6m de raio",
  duration: "Cena",
  resistance: "Nenhuma (manobra agarrar)",
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Aumenta o raio da área em +3m.",
    },
    {
      cost: "+2 PM",
      effect: "Aumenta o dano dos tentáculos em +2d6.",
    },
  ],
  },
  { id: "Terremoto",
  ...
  enhancements: [
    ...
    {
      cost: "+2 PM",
      effect: "Muda a resistências para nenhum. Como parte da execução da magia, você faz um ataque corpo a corpo contra o alvo. Se acertar, causa o dano do ataque e da magia.",
    },
    {
      cost: "+2 PM",
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Muda o alcance para curto. Em vez de tocar no alvo, você dispara um raio púrpura da ponta de seu dedo indicador.",
    },
    {
      cost: "+10 PM",
      effect: "Muda o alcance para curto e o alvo para inimigos no alcance. Em vez de tocar no alvo, você dispara raios púrpuras da ponta de seus dedos.",
    },
  ],
  },
  { id: "Toque Vampírico",
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Muda a resistências para nenhum como parte da execução da magia, você pode fazer um ataque corpo a corpo contra o alvo. Se acertar, causa o dano do ataque e da magia, e recupera pontos de vida iguais à metade do dano da magia.",
    },
    {
      cost: "+2 PM",
      effect: "Aumenta o dano em +2d6.",
    ...
    {
      cost: "+2 PM",
      effect: "Muda o alcance para pessoal, o alvo para você e a duração para cena. Em vez do normal, a cada rodada você pode gastar uma ação padrão para tocar 1 criatura e causar 3d6 pontos de dano. Você recupera pontos de vida iguais à metade do dano causado. Requer 3º círculo.",
    },
  ],
  },
  { id: "Tranca Arcana",
  ...
  enhancements: [
    {
      cost: "Truque (muda a execução)",
      effect: "Muda o alcance para curto. Em vez do normal, pode abrir ou fechar um objeto de tamanho Grande ou menor, como uma porta ou baú. Não afeta objetos trancados.",
    },
    {
      cost: "+1 PM",
      effect: "Muda o alcance para curto e a duração para instantânea. Em vez do normal, a magia abre portas, baús e janelas trancadas, presas, barradas ou protegidas por Tranca Arcana (o efeito é dissipado) a sua escolha. Ela também afrouxa grilhões e solta correntes.",
    },
    {
      cost: "+5 PM",
      effect: "Aumenta a CD para abrir o alvo em +5.",
    },
    {
      cost: "+5 PM",
      effect: "Muda o alvo para 1 objeto de qualquer tamanho, podendo afetar até mesmo os portões de um castelo. Requer 3º círculo.",
    },
  ],
  },
  { id: "Tranquilidade",
  ...
  enhancements: [
    ...
    {
      cost: "+5 PM",
      effect: "Muda o alcance para médio e o alvo para criaturas escolhidas. Requer 3º círculo.",
    },
  ],
  },
  { id: "Transformação de Guerra",
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Aumenta os bônus na Defesa, testes de ataque e rolagens de dano corpo a corpo em +1, e os PV temporários em +10.",
    },
    {
      cost: "+2 PM",
      effect: "Adiciona componente material (barra de adamante no valor de T$ 100). Sua forma de combate ganha um aspecto metálico e sem expressões. Além do normal, você recebe redução de dano 10 e imunidade a atordoamento e efeitos de cansaço, encantamento, metabolismo, trevas e veneno, e não precisa respirar.",
    },
  ],
  },
  ...
  enhancements: [
    ...
    {
      cost: "+1 PM",
      effect: "Muda o alcance para toque, o alvo para 1 construto e a duração para instantânea. Em vez do normal, cura 2d8 PV do alvo. Você pode gastar 2 PM adicionais para aumentar a cura em +1d8.",
    },
    {
      cost: "+2 PM",
      effect: "Aumenta o limite de tamanho do objeto em uma categoria.",
    },
    {
      cost: "+3 PM",
      effect: "Aumenta o preço máximo do objeto criado em um fator de x10 (+3 PM por T$ 250 de preço, +6 PM por T$ 2.500 de preço e assim por diante).",
    },
    {
      cost: "+5 PM",
    ...
    {
      cost: "+9 PM",
      effect: "Como o aprimoramento anterior, mas passa a afetar itens mágicos.",
    },
  ],
  },
  { id: "Velocidade",
  ...
  enhancements: [
    {
      cost: "+0 PM",
      effect: "Muda a duração para cena. A ação adicional que você pode fazer é apenas de movimento. Uma criatura só pode receber uma ação adicional por turno como efeito de Velocidade.",
    },
    {
      cost: "+7 PM",
      effect: "Muda o alvo para criaturas escolhidas no alcance. Requer 4º círculo.",
    },
    {
      cost: "+7 PM",
  ...
  enhancements: [
    {
      cost: "+3 PM",
      effect: "O objeto oferece o mesmo bônus em testes de resistência. Requer 3º círculo.",
    },
    {
      cost: "+4 PM",
      effect: "Aumenta o bônus em +1.",
    },
    {
      cost: "+7 PM",
      effect: "O objeto também oferece redução de dano 5. Requer 4º círculo.",
    },
  ],
  },
  { id: "Viagem Arbórea",
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Muda o alcance para toque, o alvo para até cinco criaturas e a duração para instantânea. Os alvos entram em uma planta (de tamanho Médio ou maior) e saem em outra planta do mesmo tamanho a até 100km de distância, especificada em direção e distância aproximadas (como “50km ao norte”).",
    },
  ],
  },
  { id: "Viagem Planar",
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Muda o alvo para até cinco criaturas voluntárias que você esteja tocando.",
    },
  ],
  },
  { id: "Vidência",
  ...
  enhancements: [
    {
      cost: "+1 PM",
      effect: "Muda o alcance para toque e o alvo para 1 criatura.",
    },
    {
      cost: "+1 PM",
      effect: "Além do normal, o alvo fica com sentidos apurados; ele recebe +10 em todos os testes de Percepção.",
    },
    {
      cost: "+2 PM",
      effect: "Além do normal, o alvo escuta falsidades; ele recebe +10 em todos os testes de Intuição.",
    },
    {
      cost: "+4 PM",
      effect: "Além do normal, o alvo enxerga através de paredes e barreiras com 30cm de espessura ou menos (as paredes e barreiras parecem translúcidas).",
    },
  ],
  },
  { id: "Visão Mística",
  ...
  enhancements: [
    ...
    {
      cost: "+2 PM",
      effect: "Também pode enxergar objetos e criaturas invisíveis. Eles aparecem como formas translúcidas.",
    },
  ],
  },
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Aumenta os PV temporários recebidos em +1d10. Caso a magia cause dano, em vez disso aumenta o dano causado em +1d10.",
    },
    {
      cost: "+5 PM",
  ...
  enhancements: [
    ...
    {
      cost: "+4 PM",
      effect: "Muda a duração para um dia. Requer 4º círculo.",
    },
    {
      cost: "+4 PM",
      effect: "Muda o alcance para curto e o alvo para até 10 criaturas. Requer 4° círculo.",
    },
  ],
  },
  { id: "Voz Divina",
  ...
  enhancements: [
    ...
    {
      cost: "+1 PM",
      effect: "Você pode falar com plantas (normais ou monstruosas) e rochas. Plantas e rochas têm percepção limitada de seus arredores e normalmente fornecem respostas simplórias.",
    },
  ],
  },
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Muda o alcance para toque e o alvo para 1 criatura. Requer 2º círculo.",
    },
    {
      cost: "+2 PM",
      effect: "Aumenta o dano em +1d6 (total de dados limitado pelo círculo máximo de magia que você pode lançar). Requer 3º círculo.",
    },
    {
      cost: "+3 PM",
...
{ id: "Aura de Morte",
  ...
  enhancements: [
    {
      cost: "+1 PM",
      effect: "Aumenta a perda de vida para outras criaturas em +1d8 (número de dados de perda de vida máximos limitados pelo círculo máximo de magia que você pode lançar). Requer 3º círculo.",
    },
    {
      cost: "+3 PM",
      effect: "Adiciona resistência (Fortitude parcial). Além do normal, outras criaturas que percam pontos de vida pela magia devem fazer um teste de Fortitude. Se falharem, não podem recuperar PV por 1 rodada. Requer 3º círculo.",
    },
  ],
},
{ id: "Conjurar Armadilha",
  ...
  execution: "Completa",
  range: "Curto",
  target: "Efeito: 1 armadilha conjurada",
  duration: "Permanente",
  resistance: "Nenhuma",
  description: "Esta magia modifica o terreno e/ou a arquitetura de um ponto no alcance, transformando-o em uma armadilha de caçador (Tormenta20, p. 50) a sua escolha. A armadilha criada segue as mesmas regras de armadilhas, mas a CD dos testes para encontrá-la e resistir a ela é a da magia. Embora seja produzida por magia, a armadilha ainda pode ser superada por meios mundanos normais. Depois de ativada, seja bem-sucedida ou não, a armadilha não volta a se reativar: fica inerte e inofensiva, devendo ser conjurada outra vez.",
  origin: "Herois de Arton",
  enhancements: [
    {
      cost: "+1 PM",
      effect: "Seus poderes que afetam armadilhas também afetam a armadilha criada pela magia.",
    },
    {
      cost: "+3 PM",
      effect: "Quando lança a magia, você pode escolher qualquer número de criaturas no alcance para não serem afetadas pela armadilha. Requer 2° círculo.",
    },
    {
      cost: "+5 PM",
      effect: "Muda a execução para padrão. A armadilha pode ser conjurada diretamente em uma área ocupada por uma criatura, o que a aciona imediatamente. Requer 3º círculo.",
    },
    {
      cost: "+1 PM",
      effect: "(Apenas Armadilheiros Mestres e Caçadores) Reduz o tempo de execução para movimento.",
    },
    {
      cost: "+4 PM",
      effect: "(Apenas Armadilheiros Mestres) Em vez do normal, você pode conjurar uma das suas armadilhas de armadilheiro mestre.",
    },
  ],
},
{ id: "Coração Imortal",
  ...
  enhancements: [
    {
      cost: "+2 PM",
      effect: "Muda a duração para 1 dia.",
    },
    {
      cost: "+2 PM",
      effect: "Aumenta a cura do aprimoramento abaixo para +10 PV.",
    },
    {
      cost: "+4 PM",
      effect: "Adiciona componente material (um coração de pedra no valor de T$ 100). Além do normal, quando seus pontos de vida são reduzidos a 0 ou menos, você cura 30 PV e a magia se encerra. Você só pode ser curado por este aprimoramento uma vez por dia.",
    },
  ],
},
{ id: "Desafio Corajoso",
  ...
  enhancements: [
    {
      cost: "+3 PM",
      effect: "Muda o alvo para 1 criatura ou objeto. Requer 4° círculo.",
    },
  ],
},
{ id: "Descobrir Fraqueza",
  ...
  enhancements: [
    {
      cost: "+1 PM",
      effect: "Aumenta o bônus no teste em +5.",
    },
    {
      cost: "+1 PM",
      effect: "Além do normal, sua próxima rolagem de dano contra a criatura nessa cena ignora 10 pontos da redução de dano dela. Requer 2° círculo.",
    },
    {
      cost: "+2 PM",
      effect: "Além do normal, você recebe +2 em testes contra a criatura até o fim da cena. Requer 2° círculo.",
    },
  ],
},
{   id: "Desfazer Engenhoca",
    ...
    execution: "Padrão",
    range: "Médio",
    target: "Esfera com 3m de raio ou 1 criatura ou engenhoca",
    duration: "Instantânea",
    resistance: "Veja texto",
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Além do normal, você recebe +5 no seu teste de Misticismo para dissipar uma engenhoca para cada vez que a viu ser usada na cena.",
      },
      {
        cost: "+5 PM",
        effect: "Além do normal, a magia ignora qualquer efeito ativo gerado por engenhocas (por exemplo, um Campo Antimagia).",
      },
      {
        cost: "+12 PM",
  ...
  { id: "Discrição",
    ...
    enhancements: [
      {
        cost: "+1 PM",
        effect: "Muda o alvo para 1 criatura. Requer 2º círculo.",
      },
      {
        cost: "+2 PM",
        effect: "Aumenta a penalidade em testes para –15. Requer 2º círculo.",
      },
      {
        cost: "+3 PM",
        effect: "Além do normal, o alvo não pode ser detectado por magias de adivinhação. Requer 4° círculo.",
      },
    ],
  },
  { id: "Distração Fugaz",
    ...
    enhancements: [
      {
        cost: "+1 PM",
        effect: "Além do normal, se falhar no teste de Vontade o alvo também sofre –5 em testes de Diplomacia e Intimidação até o fim da cena.",
      },
      {
        cost: "+1 PM",
        effect: "Muda o alvo para 1 criatura. Requer 2º círculo.",
      ...
      {
        cost: "+2 PM",
        effect: "Em vez de desprevenido, o alvo fica atordoado (apenas uma vez por cena).",
      },
      {
        cost: "+2 PM",
        effect: "Afeta todos os alvos válidos a sua escolha dentro do alcance. Requer 2º círculo.",
      },
    ],
  },
  { id: "Emular Magia",
    ...
    enhancements: [
      {
        cost: "+1 PM",
        effect: "A magia emulada pode ser de qualquer tipo, arcana ou divina.",
      },
    ],
  },
  { id: "Espírito Balístico",
    ...
    execution: "Padrão",
    range: "Curto",
    target: "Efeito: 1 criatura conjurada",
    duration: "Sustentada",
    resistance: "Nenhuma",
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Aumenta o dano em um dado do mesmo tipo (total de dados limitado pelo círculo máximo de magia que você pode lançar).",
      },
      {
        cost: "+2 PM",
        effect: "Muda o número de espíritos para dois. Requer 2º círculo.",
      },
      {
        cost: "+5 PM",
        effect: "Muda o número de espíritos para três. Requer 3º círculo.",
      },
      {
        cost: "+3 PM",
        effect: "(Apenas Golem [energia elemental], Qareen ou Kallyanach) Muda o dado de dano para d8 e o tipo de dano para o tipo escolhido para sua habilidade racial elemental.",
      },
    ],
  },
  { id: "Farejar Fortuna",
    ...
    duration: "Cena",
    resistance: "Nenhuma",
    description: "Ao lançar esta magia, você descobre se existe algum tesouro em alcance longo. Para este efeito, “tesouro” é qualquer acúmulo de itens valiosos (acima do dinheiro inicial de um personagem do seu nível) que não estejam sendo carregados ou vestidos por uma criatura inteligente. Você sabe se há tesouros na área, mas não recebe nenhuma outra informação a respeito, como a direção ou localização do tesouro, seu valor exato, obstáculos no caminho... nada disso é informado pela magia.",
    origin: "Herois de Arton",
    enhancements: [
      {
        cost: "+1 PM",
        effect: "Muda o alcance para toque, o alvo para um item recém-encontrado e a duração para instantânea. Em vez do normal, você recebe +5 em testes de perícia para identificar o item.",
      },
      {
        cost: "+2 PM",
        effect: "Além do normal, você recebe +5 em testes de perícia para localizar o tesouro.",
      },
      {
        cost: "+2 PM",
        effect: "Em vez do normal, quando você rola qualquer dado para definir um tesouro, pode rolar dois dados e escolher qual resultado usar.",
      },
    ],
  },
  { id: "Maaais Klunc",
    ...
    target: "Você",
    duration: "Cena",
    resistance: "Nenhuma (veja aprimoramentos)",
    description: "Esta magia surgiu com o objetivo de invocar a força estupenda e estapafúrdia de certo bárbaro lendário, capaz de alcançar dimensões colossais. Infelizmente (ou talvez felizmente) seus efeitos reais são muito mais brandos. Ao lançar a magia, você adquire uma fantástica Força +10. Um relevante efeito colateral, contudo, é que sua Inteligência cai para acachapantes –3. Não, não uma penalidade de –3; um valor –3! Penalidades no atributo são aplicadas após isso. Pela duração de Maaais Klunc, você não pode lançar magias, nem é capaz de interromper esta magia de forma voluntária. O mestre pode (vai) exigir testes de Inteligência mesmo para as tarefas mentais mais simplórias, como achar a saída de um aposento vazio, diferenciar aliados de inimigos ou determinar qual extremidade da arma vai na direção do adversário.",
    origin: "Herois de Arton",
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Muda o alcance para toque e o alvo para 1 criatura voluntária (por que alguém seria voluntário?). Requer 2º círculo.",
      },
      {
        cost: "+5 PM",
        effect: "Muda o alcance para curto e o alvo para 1 criatura involuntária (Vontade evita). Requer 3º círculo.",
      },
    ],
  },
  { id: "Máquina de Combate",
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Além do normal, os ataques corpo a corpo do alvo causam +1d6 pontos de dano.",
      },
      {
        cost: "+2 PM",
        effect: "Além do normal, o alvo recebe +2 na Defesa.",
      },
      {
        cost: "+2 PM",
  ...
  },
  {
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Muda a redução de impacto para RD 5 e a fortificação para 50%. Requer 2º círculo.",
      },
      {
        cost: "+2 PM",
        effect: "Muda o alcance para toque e o alvo para 1 criatura viva.",
      },
    ],
  },
  {
    ...
    enhancements: [
      {
        cost: "+5 PM",
        effect: "Você pode determinar uma palavra-chave que, pronunciada por qualquer pessoa em alcance curto, faz a poção explodir. Requer 3° círculo.",
      },
      {
        cost: "+7 PM",
        effect: "Muda o alcance para pessoal e o alvo para área (esfera com 9m de raio). A magia afeta mesmo poções na área que estejam sendo carregadas. Requer 4° círculo.",
      },
    ],
  },
  {
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Muda o alcance para toque e o alvo para 1 criatura voluntária. Requer 3º círculo.",
      },
    ],
  },
  {
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Muda o bônus em testes de ataque e na margem de ameaça para +2.",
      },
      {
        cost: "+2 PM",
        effect: "Muda o alcance para toque e o alvo para 1 criatura. Requer 2º círculo.",
      ...
      {
        cost: "+5 PM",
        effect: "Além do normal, se você estiver empunhando uma arma ou um item esotérico com essa mão, ele recebe os benefícios do material especial mitral (mesmo que já possua outro material especial). Requer 2° círculo.",
      },
    ],
  },
  {
    ...
    enhancements: [
      {
        cost: "+1 PM",
        effect: "A arma ignora camuflagem leve e penalidades por cobertura leve.",
      },
      {
        cost: "+1 PM",
        effect: "Além do normal, a arma fornece +1 em testes de ataque e rolagens de dano feitos dentro do seu alcance original.",
      },
      {
        cost: "+2 PM",
        effect: "Aumenta o bônus do aprimoramento acima em +1 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar).",
      },
      {
        cost: "+2 PM",
        effect: "A margem de ameaça da arma aumenta em +1. Requer 2° círculo.",
      },
      {
        cost: "+5 PM",
        effect: "Muda o alvo para uma arma de arremesso e a duração para sustentada. Em vez do normal, a arma recebe o benefício do encanto dançarina. Requer 3° círculo.",
      },
    ],
  },
  {
    ...
    target: "2 criaturas voluntárias",
    duration: "Instantânea",
    resistance: "Nenhuma (ou Vontade, veja aprimoramento)",
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Aumenta o número de alvos em +2. Você determina com quais criaturas cada alvo troca de lugar.",
      },
      {
        cost: "+5 PM",
        effect: "A troca não exige linha de efeito, mas os alvos ainda devem estar dentro do alcance. Requer 3º círculo.",
      },
      {
        cost: "+5 PM",
        effect: "Muda o alvo para 2 criaturas do tipo lacaio e adiciona resistência (Vontade anula). Requer 4º círculo.",
      },
    ],
  },
  { id: "Viagem Onírica",
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Você pode falar em sua forma incorpórea. Requer 3º círculo.",
      },
      {
        cost: "+5 PM",
        effect: "Você pode lançar magias em sua forma incorpórea. Requer 4º círculo.",
      },
    ],
  },
  { id: "Arma de Jade",
    ...
    enhancements: [
      {
        cost: "+1 PM",
        effect: "A arma causa +1d4 de dano de eletricidade.",
      },
      {
        cost: "+2 PM",
        effect: "Aumenta o bônus de ataque e dano em +1 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar).",
      },
      {
        cost: "+2 PM ",
        effect: "(Apenas Devotos de Lin-Wu) Muda o bônus de dano do aprimoramento acima para +2d4.",
      },
    ],
  },
  { id: "Arsenal de Allihanna",
    ...
    execution: "Padrão",
    range: "Pessoal",
    target: "Efeito: arma criada em sua mão",
    duration: "Cena",
    resistance: "Nenhuma",
  ...
  { id: "Bofetada de Nimb",
    ...
    enhancements: [
      {
        cost: "+1 PM",
        effect: "Alvos que falhem na resistência ficam vulneráveis pela cena.",
      },
      {
        cost: "+2 PM",
        effect: "Muda o alvo para 1 criatura.",
      ...
      {
        cost: "+2 PM",
        effect: "Em vez do normal, a mão dá leves tapinhas que acalmam os alvos e anulam uma condição entre abalado, alquebrado, apavorado e frustrado. Requer 2° círculo.",
      },
      {
        cost: "+3 PM",
        effect: "Alvos que falhem na resistência ficam desprevenidos por 1d4+1 rodadas, em vez de apenas 1.",
      },
      {
        cost: "+5 PM ",
        effect: "(Apenas Devotos de Nimb) Afeta todos os alvos válidos a sua escolha dentro do alcance.",
      },
    ],
  },
  { id: "Couraça de Allihanna",
    ...
    duration: "Cena",
    resistance: "Nenhuma (ou Fortitude, veja aprimoramento)",
    ...
    enhancements: [
      {
        cost: "+1 PM",
        effect: "Aumenta a Defesa em +1 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar).",
      },
      {
        cost: "+2 PM",
        effect: "Além do normal, suas magias de evocação e transmutação custam –1 PM.",
      },
      {
        cost: "+2 PM",
        effect: "O alvo é recoberto por folhas e galhos. Você recebe +5 em testes de Furtividade e pode se esconder mesmo sem camuflagem ou cobertura disponível.",
      },
      {
        cost: "+2 PM",
        effect: "Além do normal, o alvo fornece o mesmo bônus em testes de resistência. Requer 3° círculo.",
      },
      {
        cost: "+3 PM",
        effect: "Além do normal, o alvo é recoberto esporos de cogumelo. Quando uma criatura faz um ataque corpo a corpo contra você, ela deve fazer um teste de Fortitude (CD da magia). Se falhar, fica paralisada por 1 rodada (apenas uma vez por cena) e lenta. Se passar, fica lenta por 1 rodada. Requer 3° círculo.",
      },
    ],
  },
  { id: "Escapatória de Hyninn",
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Muda o alcance para curto e o alvo para 1 criatura. Requer 2º círculo.",
      },
      {
        cost: "+5 PM",
        effect: "Muda a execução para padrão e a duração para cena. Em vez do normal, o bônus se aplica a todos os testes destas perícias pela duração. Requer 3º círculo.",
      },
      {
        cost: "+3 PM",
        effect: "(Apenas Devotos de Hyninn) Além do normal, o alvo pode usar Evasão (Tormenta20, p. 73).",
      },
      {
        cost: "+7 PM",
        effect: "(Apenas Devotos de Hyninn) Além do normal, o alvo pode usar Evasão Aprimorada (Tormenta20, p. 75). Requer 4° círculo.",
      },
    ],
  },
  { id: "Euforia de Valkaria",
    ...
    duration: "Cena",
    resistance: "Nenhuma",
    description: "Esta magia enche o alvo de disposição, apagando o medo (e bom senso) em seu coração e impedindo-o de ser intimidado por desafios árduos. O alvo se torna imune a medo e recebe +1 em testes de ataque quando luta em desvantagem (um encontro contra o dobro de inimigos que seu grupo, ou com ND maior que o do grupo).",
    origin: "Deuses de Arton",
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Aumenta o bônus em testes de ataque em +1 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar).",
      },
      {
        cost: "+2 PM",
        effect: "Muda a execução para reação e a duração para 1 rodada. Em vez do normal, o alvo recebe imunidade a medo e +5 em Vontade. Requer 2° círculo.",
      },
      {
        cost: "+2 PM",
        effect: "Muda o alvo para área de esfera com 3m de raio. Você e todos os aliados na área são afetados pela magia. Requer 2º círculo.",
      },
      {
        cost: "+1 PM",
        effect: "(Apenas Devotos de Valkaria) Muda o alcance para toque e o alvo para 1 criatura.",
      },
    ],
  },
  { id: "Execução de Thwor",
    ...
    enhancements: [
      ...
      {
        cost: "+5 PM",
        effect: "Em vez do normal, a magia afeta 1 alvo sob efeito de uma condição mental. Requer 3º círculo.",
      },
      {
        cost: "+7 PM",
        effect: "(Apenas Devotos de Thwor) Se o ataque for um acerto crítico naturalmente, em vez do normal ele causa o efeito de um golpe de misericórdia (Tormenta20, p. 235). Requer 5º círculo.",
      },
    ],
  },
  { id: "Flecha de Luz",
    ...
    enhancements: [
      {
        cost: "+1 PM",
        effect: "Muda o alvo para uma criatura que tenha causado dano a você ou a seus aliados na última rodada e os dados de dano da magia para d10.",
      },
      {
        cost: "+2 PM",
        effect: "Aumenta o dano em +1d8+1.",
      ...
      {
        cost: "+2 PM",
        effect: "Aumenta o número de alvos em +1 (número de alvos adicionais limitado pelo círculo máximo de magia que você pode lançar).",
      },
      {
        cost: "+2 PM",
        effect: "(Apenas Arcanos) Alvos que falhem na resistência ficam cegos por 1 rodada e então ofuscados. Requer 2º círculo.",
      },
      {
        cost: "+3 PM",
        effect: "(Apenas Arqueiros de Lenórienn) Muda o alcance para pessoal, o alvo para seu arco arcano, a duração para sustentada e a resistência para nenhuma. Em vez do normal, o alvo emite luz como uma tocha e causa +2d8+2 pontos de dano de luz. Criaturas que sofram dano do arco ficam ofuscadas (veja Arqueiro de Lenórienn em Heróis de Arton).",
      },
      {
        cost: "+1 PM",
        effect: "(Apenas Elfos) Muda o alvo para 1 duyshidakk ou 1 devoto de Aharadak, Tauron ou Thwor. Muda os dados de dano para d10.",
      },
      {
        cost: "+2 PM",
        effect: "(Apenas Divinos) Além do normal, para cada alvo que falhar na resistência, o próximo aliado que causar dano a ele recebe uma quantidade de PV temporários igual à metade do dano causado pela magia. Requer 2º círculo.",
      },
    ],
  },
  { id: "Frescor de Lena",
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Aumenta em 1 o círculo de magia afetado (limitado pelo círculo máximo de magia que você pode lançar).",
      },
      {
        cost: "+2 PM",
        effect: "Muda o alcance para toque, a área para alvo (1 criatura) e a duração para 1 dia. Em vez do normal, suprime uma doença do alvo. Requer 2° círculo.",
      },
      {
        cost: "+3 PM",
        effect: "(Apenas Devotos de Lena) Como acima, mas quando faz o teste da doença nesse dia, o alvo recebe um bônus de +5. Requer 3° círculo.",
      },
      {
        cost: "+9 PM",
        effect: "(Apenas Devotos de Lena) Muda o alcance para toque, a área para alvo (1 criatura) e adiciona componente material (ervas no valor de T$ 1.000). O alvo recupera 1 ponto de atributo perdido por uma doença. Requer 4° círculo.",
      },
    ],
  },
  { id: "Fúria dos Antepassados",
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Aumenta o número de alvos em +1. Requer 2° círculo.",
      },
      {
        cost: "+4 PM",
        effect: "Aumenta o dano psíquico e de luz em +1d6 cada.",
      },
      {
        cost: "+0 PM",
        effect: "(Apenas Devotos de Lin-Wu) Muda o alvo para 1 criatura inteligente (Int –3 ou maior).",
      },
    ],
  },
  { id: "Futuro Melhor",
    ...
    enhancements: [
      ...
      {
        cost: "+2 PM",
        effect: "(Apenas Devotos de Thyatis) Muda o bônus para 1d4+2.",
      },
    ],
  },
  { id: "Infortúnio de Sszzaas",
    ...
    enhancements: [
      {
        cost: "+1 PM",
        effect: "Além do normal, a vítima perde imunidade a venenos até o fim da próxima rodada. Requer 2° círculo.",
      },
      {
        cost: "+2 PM",
        effect: "Aumenta a penalidade em –1 (penalidade máxima limitada pelo círculo máximo de magia que você pode lançar).",
      },
      {
        cost: "+3 PM",
        effect: "(Apenas Devotos de Sszzaas) Além do normal, quando o alvo morre, deixa para trás um pequeno cristal com memórias e segredos. Ao resolver uma busca (Tormenta20, p. 278), um personagem pode quebrar um desses cristais para receber +2 em um teste de perícia. Requer 3° círculo.",
      },
    ],
  },
  { id: "Instante Estoico",
    ...
    enhancements: [
      {
        cost: "+1 PM",
        effect: "Muda a RD para 20. Requer 2° círculo.",
      },
      {
        cost: "+2 PM",
        effect: "Além do normal, para cada 10 pontos de dano que a magia reduzir em um turno, sua próxima rolagem de dano feita até a próxima rodada causa +1d6 pontos de dano de essência.",
      },
      {
        cost: "+1 PM",
        effect: "(Apenas Devotos de Khalmyr) Muda a execução para padrão e a duração para cena, até ser descarregada. Em vez do normal, quando sofre dano não mágico, você pode receber RD 10 contra esse dano. A magia é descarregada após você usar este efeito pela terceira vez. Requer 3º círculo.",
      },
      {
        cost: "+2 PM",
        effect: "(Apenas Devotos de Khalmyr) Muda o alcance para toque e o alvo para 1 criatura.",
      },
    ],
  },
  { id: "Magia Dadivosa",
    ...
    enhancements: [
      {
        cost: "+1 PM",
        effect: "Muda o alcance para curto e o alvo para 1 criatura. Requer 3° círculo.",
      },
      {
        cost: "+0 PM",
        effect: "(Apenas Devotos de Wynna) Muda a execução para padrão, o ganho para +2 PM temporários e o limite para descarregar para +8 PM.",
      },
    ],
  },
  { id: "Orbe do Oceano",
    ...
    enhancements: [
      {
        cost: "+4 PM",
        effect: "Muda a duração para cena. Requer 3º círculo.",
      },
      {
        cost: "+2 PM",
        effect: "(Apenas Devotos de Oceano) Além do normal, você é considerado submerso. Isso exige que você prenda a respiração (a menos que possa respirar debaixo d’água), mas faz com que sofra apenas a metade do dano de armas de corte e impacto que não sejam armas naturais e é considerado submerso para benefícios de suas habilidades que dependam dessa situação.",
      },
    ],
  },
  { id: "Paixão de Marah",
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Muda o alcance para curto e o alvo para 1 criatura.",
      },
      {
        cost: "+1 PM",
        effect: "(Apenas Devotos de Marah) Além do normal, o alvo recebe +1 em Carisma. Esse aumento não oferece PV ou PM adicionais.",
      },
      {
        cost: "+3 PM",
        effect: "(Apenas Devotos de Marah) Muda a duração para 1 dia. Requer 2º círculo.",
      },
    ],
  },
  { id: "Percepção Rubra",
    ...
    enhancements: [
      ...
      {
        cost: "+2 PM",
        effect: "(Apenas Devotos de Aharadak) Aumenta o bônus em +1 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar).",
      },
    ],
  },
  { id: "Perturbação Sombria",
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Muda o efeito para aura de 9m.",
      },
      {
        cost: "+5 PM",
        effect: "Muda o alcance para toque e o alvo para 1 criatura ou objeto. O alvo emana a aura.",
      },
      {
        cost: "+5 PM",
        effect: "Você pode escolher quais criaturas são afetadas pela aura. Requer 2º círculo.",
      },
      {
        cost: "+9 PM",
        effect: "Muda o alcance para curto, o alvo para área (esfera de 6m de raio), a execução para 1 hora, a duração para permanente e adiciona componente material (incenso e óleos no valor de T$ 1.000). Requer 5° círculo.",
      },
      {
        cost: "+2 PM",
        effect: "(Apenas Devotos de Tenebra) Adiciona resistência (Vontade parcial). Além do normal, criaturas que comecem seu turno dentro da área ficam abaladas. Passar no teste de resistência evita a condição e impede que a criatura seja abalada por esta magia até o fim da cena. Requer 2° círculo.",
      },
    ],
  },
  { id: "Poder de Kallyadranoch",
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Aumenta a CD em +1 (bônus máximo limitado pelo círculo máximo de magias que você pode lançar). Requer 3° círculo.",
      },
      {
        cost: "+1 PM",
  ...
  { id: "Posse de Arsenal",
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "(Apenas Devotos de Arsenal) Além do normal, você também pode convocar uma arma à sua mão mesmo se ela tiver sido arremessada voluntariamente.",
      },
    ],
  },
  { id: "Proteção de Tauron",
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Além do normal, você pode usar habilidades mágicas com alcance de toque no alvo como se elas tivessem alcance curto.",
      },
      {
        cost: "+2 PM",
        effect: "Aumenta o bônus na Defesa em +2 (bônus máximo limitado ao dobro do círculo máximo de magia que você pode lançar). Requer 2º círculo.",
      },
      {
        cost: "+2 PM",
        effect: "(Apenas Minotauros) Além do normal, uma vez por rodada, quando uma criatura faz uma ação hostil contra o protegido, você pode gastar 1 PM para fazer um ataque corpo a corpo contra ela, desde que ela esteja em seu alcance pessoal.",
      },
    ],
  },
  { id: "Punição do Profano",
    ...
    enhancements: [
      ...
      {
        cost: "+3 PM",
        effect: "Muda o alvo para criaturas escolhidas. Requer 3° círculo.",
      },
    ],
  },
  ...
  { id: "Siroco de Azgher",
    ...
    duration: "Instantânea",
    resistance: "Reflexos reduz à metade",
    description: "Invocando a fúria do Deus-Sol, você cria uma breve e focada tempestade de areia, capaz de esfolar a carne dos ossos! Criaturas afetadas sofrem dano de corte conforme seu grau de proteção: 3d6 se estiverem sem armadura, 2d6 se estiverem com armadura leve e 1d6 se estiverem com armadura pesada.",
    origin: "Deuses de Arton",
    enhancements: [
      {
        cost: "+1 PM",
      ...
      {
        cost: "+1 PM",
        effect: "Muda o tipo de dano para luz.",
      },
      {
        cost: "+1 PM",
        effect: "Muda o alcance para pessoal e o alvo para área (cone de 9m). Requer 2° círculo.",
      },
      {
        cost: "+1 PM",
        effect: "(Apenas Devotos de Azgher) Além do normal, criaturas que falhem na resistência ficam em chamas e sangrando.",
      },
    ],
  },
  { id: "Sorriso da Fortuna",
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Aumenta em +1 o total de usos antes de a magia ser descarregada.",
      },
      {
        cost: "+2 PM",
        effect: "Muda a execução para reação, o alcance para curto e o alvo para 1 criatura. Além disso, você lança a magia usando apenas concentração (Tormenta20, p. 170). Em vez do normal, a magia confunde um dos jogadores presentes, que rola seu teste de Jogatina com dois dados e usa o pior resultado.",
      },
      {
        cost: "+3 PM",
        effect: "Além do normal, você pode escolher um “número da sorte”. Se o número da sorte for rolado em qualquer um dos dados, o resultado conta como um 20 natural. Requer 2° círculo.",
      },
      {
        cost: "+1 PM",
        effect: "(Apenas Devotos de Hyninn) Muda a execução para reação e a duração para instantânea. Em vez do normal, quando faz seu primeiro teste de uma perícia em uma cena, você pode rolar dois dados e usar o melhor resultado.",
      },
    ],
  },
  { id: "Toque de Megalokk",
    ...
    enhancements: [
      {
        cost: "+1 PM",
        effect: "A margem de ameaça de suas armas naturais aumenta em +1.",
      },
      {
        cost: "+2 PM",
        effect: "O dano de suas armas naturais aumenta em um passo. Requer 3° círculo.",
      },
      {
        cost: "+5 PM",
        effect: "(Apenas Devotos de Megalokk) Além do normal, você recebe redução de dano 5. Requer 2º círculo.",
      },
    ],
  },
  { id: "Traição da Lâmina",
    ...
    enhancements: [
      {
        cost: "+1 PM",
        effect: "Em vez do usuário, a arma se volta para outra criatura em alcance curto que você possa perceber, a sua escolha.",
      },
      {
        cost: "+1 PM",
        effect: "Muda o alvo para 1 arma e a duração para 1 dia, até ser descarregada. Requer 3° círculo.",
      },
      {
        cost: "+2 PM",
        effect: "Aumenta o número de alvos em +1.",
      ...
      {
        cost: "+2 PM",
        effect: "Adiciona componente material (uma dose de veneno). Além do normal, o ataque envenena o usuário com o veneno utilizado como componente (a CD desse veneno é a CD da própria magia).",
      },
    ],
  },
  { id: "Traição Mágica",
    ...
    enhancements: [
      {
        cost: "+3 PM",
        effect: "Muda o alvo para criaturas escolhidas. Requer 3º círculo.",
      },
      {
        cost: "+3 PM",
        effect: "Muda a resistência para nenhuma. Requer 3º círculo.",
      },
    ],
  },
  { id: "Voz da Razão",
    ...
    enhancements: [
      {
        cost: "+2 PM",
        effect: "Muda o bônus para +10. Requer 2º círculo.",
      },
      {
        cost: "+2 PM",
