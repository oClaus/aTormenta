...
export const races: Race[] = [
  ...
  { id: "Dahllan",
    ...
    abilities: [
      ...
      description: "Você pode se comunicar com animais por meio de linguagem corporal e vocalizações. Você pode usar Adestramento para mudar atitude e persuasão com animais (veja Diplomacia). Caso receba esta habilidade novamente, recebe +2 em Adestramento.",
      },
    ],
    attributeModifiers: [
  ...
  { id: "Lefou",
    ...
    {
      name: "Deformidade",
      description: "Todo lefou possui defeitos físicos que, embora desagradáveis, conferem certas vantagens. Você recebe +2 em duas perícias à sua escolha. Cada um desses bônus conta como um poder da Tormenta (exceto para perda de Carisma). Você pode trocar um desses bônus por um poder da Tormenta à sua escolha (ele também não conta para perda de Carisma).",
    },
    ],
    attributeModifiers: [
  ...
  { id: "Qareen",
    ...
    },
    {
      ...
      description: "Você pode lançar uma magia de 1º círculo à sua escolha (atributo-chave Carisma). Caso aprenda novamente essa magia, seu custo diminui em –1 PM.",
    }
    ],
    attributeModifiers: [
  ...
  { id: "Kliren",
    ...
    abilities: [
      {
      name: "Híbrido",
      description: "Sua natureza multifacetada fez com que você aprendesse conhecimentos variados. Você se torna treinado em uma perícia à sua escolha (não precisa ser da sua classe).",
    },
    {
      name: "Engenhosidade",
    ...
    {
      name: "Vanguardista",
      description: "Você recebe proficiência em armas de fogo e +2 em Ofício (um qualquer, à sua escolha).",
    },
    ],
    attributeModifiers: [
      { attribute: "int", modifier: 2 },
  ...
  { id: "Golens-Despertos",
  name: "Golens Despertos",
  origin: "Ameaças de Arton",
  image: "/racas/golens-despertos.png",
  description: "“Compor uma sinfonia? Produzir uma obra de arte? Não, não sou capaz. Você é?”\n — Sonniah, golem lutadora \n\n Entre as raças disponíveis para personagens jogadores em Tormenta20, é apresentado o golem em sua versão mais comum — o golem de ferro elemental médio. As habilidades a seguir expandem essas regras e permitem criar outros tipos de golens despertos.",
  abilities: [
    {
      name: "Chassi",
      description: "Você leva um dia para vestir ou remover uma armadura (pois precisa acoplar as peças dela a seu chassi). Entretanto, por ser acoplada, sua armadura não conta no limite de itens que você pode usar (mas você só pode usar uma armadura). Além disso, escolha um material para seu chassi entre os abaixo.",
      subAbilities: [
        {
          name: "Barro",
          description: "Constituição +2. Seu deslocamento não é afetado por terreno difícil e você passa automaticamente em testes de Acrobacia para passar por espaços apertados. Se permanecer mais de um dia sem contato com água, você não recupera PM com descanso até voltar para a água."
        },
        {
          name: "Bronze",
          description: "+1 em dois atributos. Seu deslocamento não é reduzido por armaduras pesadas ou excesso de carga. Sua armadura não é acoplada ao seu corpo; você pode removê-la e colocá-la no tempo normal, mas ela conta em seu limite de itens vestidos."
        },
        {
          name: "Carne",
        ...
        {
          name: "Gelo Eterno",
          description: "Constituição +2. Seu deslocamento é 6m, mas não é reduzido por uso de armadura ou excesso de carga. Você recebe imunidade a frio e redução de fogo 10, mas não pode escolher elemental (fogo) ou vapor como sua fonte de energia."
        },
        {
          name: "Pedra",
        ...
        {
          name: "Sucata",
          description: "Força +1 e Constituição +1. Seu deslocamento é 6m, mas não é reduzido por uso de armadura ou excesso de carga. Quando recebe cuidados prolongados com a perícia Ofício (artesão), sua recuperação de PV aumenta em +2 por nível nesse dia (em vez de +1)."
        },
        {
          name: "Chassi Dourado",
          description: " Carisma +2, Força +1. Você pode gastar 1 PM para marcar uma criatura em alcance curto como culpada. Até o fim da cena, ou até você usar esta habilidade em outra criatura, você sempre sabe onde a criatura culpada está e, uma vez por rodada, um de seus ataques contra essa criatura causa +1d6 pontos de dano de luz.\nEmbora inevitáveis sejam criados com um único propósito e não tenham o livre arbítrio necessário para se tornarem aventureiros plenos, é possível encontrar golens feitos a partir de partes e peças de um desses seres. Se você tiver o suplemento Ameaças de Arton, esses inevitáveis podem ser usados como um tipo de chassi para golens despertos."
        },
      ]
    },
    {
    ...
    },
    {
      ...
      description: "Escolha sua fonte de energia da lista abaixo.",
      subAbilities: [
        {
          name: "Alquímica",
        ...
        {
          name: "Elemental",
          description: "Você possui um espírito elemental preso em seu corpo. Escolha entre água (frio), ar (eletricidade), fogo (fogo) e terra (ácido). Você é imune a dano desse tipo. Se fosse sofrer dano mágico deste tipo, em vez disso cura PV em quantidade igual à metade do dano."
        },
        {
          name: "Sagrada",
    ...
    {
      name: "Tamanho",
      description: "Escolha seu tamanho da lista abaixo.",
      subAbilities: [
        {
          name: "Pequeno",
          description: "Destreza +1."
        },
        {
          name: "Médio",
  ...
  attributeModifiers: [
    { attribute: "for", modifier: 1 },
    { attribute: "car", modifier: -1 },
    { description: "Modificadores adicionais variam cumulativamente conforme a escolha do Chassi e Tamanho." }
  ],
  ...
  { id: "Elfo-do-Mar",
    name: "Elfo-do-Mar",
    origin: "Ameaças de Arton",
    image: "/ameacas/elfo-do-mar.png",
    description: "“Temos histórias de guerra entre nosso povo e eles. Nunca ouviu nenhuma? Pois então.”\n — Marcielle, sereia barda \n\n Este ser lembra um elfo terrestre, embora mais baixo e corpulento, de ombros largos. Tem pele lustrosa, perolada, azul-acinzentada. As grandes orelhas têm raios, como barbatanas de peixe. Tem cabelo branco, longo, e olhos azuis amendoados. Veste apenas uma tanga leve que parece feita de algas, enquanto empunha um tridente farpado, de aspecto muito perigoso. \n Em contraste com sereias e tritões, mais inclinados à conjuração de magias, elfos-do-mar são bárbaros orgulhosos e perigosos. Lançam ataques contra em-barcações e comunidades costeiras para matar, saquear e — principalmente — roubar objetos de metal, que eles próprios não podem forjar em seu habitat. \n Estes são apenas os fatos mais conhecidos sobre os elfos-do-mar. A verdade é que muitos são pacíficos, cuidando da própria vida em suas comunidades submarinas, sem nenhum interesse em guerrear com o Reinado. Várias de suas aldeias, em regiões de ar molhado, aceitam visitantes da superfície e até moradores fixos sem receios — justamente para comercializar instrumentos e itens da terra seca, em troca de pescado, materiais únicos e tesouros do mar. Não é raro que estes elfos acabem se unindo a grupos de aventureiros; no passado, uma elfa-do-mar chamada Lenora foi aliada a heróis ilustres como Vladislav Tpish e o próprio Paladino de Arton. Apenas os membros mais rebeldes e malignos da raça se tornam saqueadores — infelizmente são estes que trazem infâmia aos demais.",
    abilities: [
      {
        name: "Arsenal do Oceano",
        description: "Você recebe proficiência em arpão, rede e tridente e +2 em testes de ataque com essas armas. Se receber proficiência em uma dessas armas novamente, pode considerá-la uma arma leve."
      },
      {
        name: "Cria das Águas",
        description: "Você possui deslocamento de natação igual a seu deslocamento em terra e visão na penumbra. Quando dentro d’água, você recebe percepção às cegas e +2 na Defesa e, em Furtividade e Sobrevivência."
      },
      {
  ...
  { id: "Jotunn",
    ...
    abilities: [
      {
      name: "Poder Jotunn",
      description: "Escolha três poderes da lista a seguir:",
      subAbilities: [
        {
          name: "Gigante",
          description: "Seu tamanho é Grande e você recebe 3 espaços de inventário por ponto de Força, ao invés de 2."
        },
        {
          name: "Manipulação Elemental",
          description: "Você aprende e pode lançar Explosão de chamas (fogo), Névoa (gelo) ou Transmutar objetos (rocha) (atributo-chave Força). Caso aprenda novamente essa magia, seu custo diminui em –1 PM."
        },
        {
          name: "Percepção Paracronal",
          description: "Você tem visões sobre o futuro, vislumbrando eventos que não aconteceram ainda. Você aprende e pode lançar Augúrio, mas o tempo de execução da magia aumenta para 1 minuto."
        },
        {
          name: "Resistência Superior",
          description: "Sua pele é um couro grosso feito de matéria elemental. Você recebe +2 na Defesa e redução 10 contra fogo (fogo), frio (gelo) ou ácido (rocha)"
        },
      ]
    }
    ],
  ...
  { id: "Vanir",
    ...
    abilities: [
      ...
      description: "Você aprende e pode lançar três magias de 1º círculo, arcanas ou divinas, à sua escolha (atributo-chave Carisma). As magias são consideradas divinas para todos os efeitos e você pode aplicar aprimoramentos nessas magias como se fosse um Druida de mesmo nível que seu nível de personagem. Caso aprenda novamente essas magias, seu custo diminui em –1 PM.",
    },
    {
      name: "Bênção da Magia Ancestral",
      description: "Você pode lançar qualquer magia que conheça sobre outra criatura inteligente com que possa se comunicar. Ao invés de ser alvo dos efeitos normais da magia, essa criatura recebe a capacidade de lançar esta magia uma única vez até o fim da cena, com os mesmos efeitos mas sem custo em PM.",
    },
    {
      name: "Elusivo",
      description: "Você passou a vida escondendo sua origem e poderes para evadir seus perseguidores. Você recebe +2 em Enganação e Intuição.",
    }
    ],
    attributeModifiers: [
      { attribute: "sab", modifier: 2 },
  ...
  { id: "Elfo de Elfheim",
    ...
    abilities: [
      {
      name: "Dökkalfar",
      description: "Ao escolher ser da linhagem Dökkalfar ganha todos estas habilidades. ",
      subAbilities: [
        {
          name: "Armamento das Sombras",
          description: "Você pode gastar 1 PM para cobrir sua arma com energia das trevas. Sua próxima rolagem de dano com a arma nesta cena causa +1d6 pontos de dano de trevas."
        },
        {
          name: "Ser das Sombras",
          description: "Você recebe visão no escuro, deslocamento de escalada 9m e redução de trevas 10."
        }
      ]
    },
    {
      name: "Ljósálfar",
      description: "Ao escolher ser da linhagem Ljósálfar ganha todos estas habilidades. ",
      subAbilities: [
        {
          name: "Armas Luminosas",
          description: "Você pode gastar uma ação de movimento e 1 PM para criar uma arma que saiba usar feita de luz sólida. A arma dura até o fim da cena ou até você soltá-la, é considerada mágica e fornece +1 em testes de ataque."
        },
        {
          name: "Filho da Luz",
          description: "Você recebe +2 em Percepção, visão no escuro e imunidade às condições cego e ofuscado."
        }
      ]
    },
    {
      name: "Voo",
      description: "Enquanto a maioria dos elfos escuros têm asas insetóides, os elfos luminosos conseguem voar usando a bênção da Luz. Você pode gastar 1 PM por rodada para voar com deslocamento de 12m.", 
    },
    ],
    attributeModifiers: [
  ...
  { id: "Anão de Svartalfheim",
    ...
    abilities: [
      {
      name: "Caminhar entre os Reinos",
      description: "Você usa as fendas entre os reinos para se mover sem ser detectado. Você aprende e pode lançar a magia Salto Dimensional (atributo-chave Inteligência), mas só pode lançá-la sobre si mesmo. Caso aprenda novamente essa magia, seu custo diminui em –1 PM.",
    },
    {
      name: "Pacifista",
      description: "Violência é sempre o último recurso para um anão. Você recebe +5 em Diplomacia e Furtividade e sempre fica abalado durante o primeiro turno de um combate.",
    },
    {
      name: "Tecelão do Improvável",
      description: "Você é capaz de usar materiais “impossíveis” como o canto dos pássaros, o aroma do orvalho ou o choro de uma criança, como matéria-prima para fabricar itens. Para você, o custo de fabricação de qualquer item mundano é um quinto do preço, ao invés de um terço.",
    },
    ],
    attributeModifiers: [
      { attribute: "int", modifier: 2 },
  ...
  { id: "Gorons",
    ...
    abilities: [
      {
      name: "Dieta Rochosa",
      description: "Você só se alimenta de verdade ao comer pedras. Se não puder se alimentar de pedras por um dia inteiro, você deve fazer um teste de Fortitude.",
    },
    {
      name: "Grande como a Montanha",
      description: "Seu tamanho é Grande e seu deslocamento é 6m.",
    },
    {
      name: "Filho da Montanha",
      description: "Você é imune a dano de fogo e não precisa fazer testes de Fortitude para resistir ao calor.",
    },
    {
      name: "Rolar como uma Pedra",
      description: "Você pode gastar 2 PM para abraçar suas pernas com seus braços e assumir uma forma arredondada como um pedregulho por uma rodada. Nesta forma, seu deslocamento se torna 9m, você ignora terreno difícil não mágico e, se executar uma investida, não sofre a penalidade de –2 em Defesa.",
    },
    ],
    attributeModifiers: [
      { attribute: "for", modifier: 2 },
  ...
  { id: "Rito",
    ...
    abilities: [
      {
      name: "Habitante das Alturas",
      description: "Você recebe +2 em Acrobacia e redução de frio 5.",
    },
    {
      name: "Visão de Cima",
      description: "Você tem visão na penumbra e, quando está voando, recebe +5 em testes de Percepção para observar.",
    },
    {
      name: "Voo Veloz",
      description: "Você pode gastar 1 PM por rodada para voar com deslocamento de 9m. Se não tiver mais PM para gastar em meio ao voo ou for derrubado por qualquer motivo, cai e sofre dano de queda normalmente."
    }
    ],
    attributeModifiers: [
      { attribute: "des", modifier: 2 },
  ...
  { id: "Duende",
    ...
    abilities: [
      {
        name: "Habilidades dos Duendes",
        description: "Nenhum conjunto pré-determinado de habilidades poderia representar os diferentes membros desta raça. Assim, para criar um duende, você precisará fazer algumas escolhas.",
      },
      {
      name: "Passo 1: Natureza",
      description: "Você é uma criatura do tipo espírito. Além disso, escolha se você será animal, vegetal ou mineral.",
      subAbilities: [
        {
          name: "Animal",
      ...
      {
      name: "Passo 2: Tamanho",
      description: "Escolha seu tamanho, entre Minúsculo, Pequeno, Médio ou Grande.",
      subAbilities: [
        {
          name: "Minúsculo",
      ...
      {
      name: "Passo 5: Limitações",
      description: "A natureza mágica e caótica dos duendes faz com que eles sejam poderosos — mas também lhes impõe várias limitações. Você recebe as habilidades a seguir.",
      subAbilities: [
        {
  ...
  { id: "Eiradaan",
    ...
    },
    {
      ...
      description: "Você está sempre sob o efeito básico da magia Visão Mística.",
    },
    {
  ...
  { id: "Zora",
    ...
    abilities: [
      {
      name: "Melodias do Povo Zora",
      description: "Você pode conjurar duas das seguintes magias: Área Escorregadia, Curar Ferimentos, Orientação, Primor Atlético ou Suporte Ambiental (atributo-chave Sabedoria). Caso aprenda novamente uma dessas magias, seu custo diminui em –1 PM.",
    },
    {
      name: "Um com a Água",
      description: "Você tem deslocamento de natação de 9m e pode falar (e lançar magias) debaixo d'água.",
    }
    ],
    attributeModifiers: [
      { attribute: "sab", modifier: 2 },
